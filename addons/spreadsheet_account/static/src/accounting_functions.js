...
import { EvaluationError } from "@mashora/o-spreadsheet";
...
functionRegistry.add("MASHORA.DEBIT", {
...
functionRegistry.add("MASHORA.BALANCE", {
...
functionRegistry.add("MASHORA.FISCALYEAR.START", {
...
functionRegistry.add("MASHORA.FISCALYEAR.END", {
...
functionRegistry.add("MASHORA.ACCOUNT.GROUP", {
...
functionRegistry.add("MASHORA.BALANCE.TAG", {
