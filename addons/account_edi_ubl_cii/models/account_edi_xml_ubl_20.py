...
from mashora import _, models, Command
from mashora.tools import html2plaintext
from mashora.tools.float_utils import float_is_zero, float_round
from mashora.addons.account.tools import dict_to_xml
from mashora.addons.account_edi_ubl_cii.models.account_edi_common import FloatFmt
from mashora.addons.account_edi_ubl_cii.tools import Invoice, CreditNote, DebitNote
from mashora.addons.account_edi_ubl_cii.tools.ubl_20_optional_fields import PEPPOL_INVOICE_OPTIONAL_FIELDS, PEPPOL_INVOICE_OPTIONAL_LINE_FIELDS, PEPPOL_CREDIT_NOTE_OPTIONAL_FIELDS, PEPPOL_CREDIT_NOTE_OPTIONAL_LINE_FIELDS
    ...
    def _add_invoice_payment_terms_nodes(self, document_node, vals):
        ...
        if payment_term:
            document_node['cac:PaymentTerms'] = {
                # The payment term's note is automatically embedded in a <p> tag in Mashora
