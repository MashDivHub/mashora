...
from mashora.addons.google_calendar.tests.test_sync_common import TestSyncGoogle
...
@tagged('mashora2google')
class TestSyncMashora2GoogleMail(TestTokenAccess, TestSyncGoogle, MailCommon):
