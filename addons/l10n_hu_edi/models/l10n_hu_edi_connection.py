...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Mashora environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Mashora can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'MASHORA' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Mashora Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': mashora_version,
            'softwareDevName': 'Mashora SA',
            'softwareDevContact': 'andu@mashora.com',
