...
from mashora.addons.payment_paymob.controllers.main import PaymobController
from mashora.addons.payment_paymob.tests.common import PaymobCommon
...
class PaymobTest(PaymobCommon, PaymentHttpCommon):
    ...
    @mute_logger('mashora.addons.payment_paymob.controllers.main')
