...
from mashora.addons.base.tests.common import DISABLED_MAIL_CONTEXT
...
from mashora.addons.website_sale_loyalty.controllers.cart import Cart
from mashora.addons.website_sale_loyalty.controllers.delivery import WebsiteSaleLoyaltyDelivery
