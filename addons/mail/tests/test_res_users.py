...
from mashora.addons.base.models.res_users import ResUsersPatchedInTest
...
from mashora.tests import RecordCapturer, tagged, users
...
class TestUser(MailCommon):
    ...
    def test_notification_type_constraint(self):
        with self.assertRaises(IntegrityError, msg='Portal user can not receive notification in Mashora'):
            mail_new_test_user(
                self.env,
