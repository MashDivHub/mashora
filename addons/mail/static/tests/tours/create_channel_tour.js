...
registry.category("web_tour.tours").add("can_create_channel_from_form_view", {
    steps: () => [
        {
            trigger: ".o-mail-DiscussSidebarChannel-itemName:contains(MashoraBot)",
            run: "click",
        },
        {
            trigger: ".o-mail-DiscussContent-threadName[title='MashoraBot']",
        },
        ...
        {
            trigger: ".breadcrumb-item:contains('MashoraBot')",
            run: "click",
        },
        {
