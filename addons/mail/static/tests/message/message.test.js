...
import { animationFrame, leave, pointerDown, press, queryFirst, waitFor } from "@mashora/hoot-dom";
import { advanceTime, mockDate, mockTouch, mockUserAgent, tick } from "@mashora/hoot-mock";
import {
    asyncStep,
...
test("edit a message with styling keeps the styling", async () => {
    ...
    await click(".o-mail-Message [title='Edit']");
    await contains(".o-mail-Composer-html.mashora-editor-editable strong:contains('Hello world')");
});
...
test("edit a message styling", async () => {
    ...
    await click(".o-mail-Message [title='Edit']");
    await focus(".o-mail-Message .o-mail-Composer-html.mashora-editor-editable");
    const editor = {
        document,
        editable: document.querySelector(
            ".o-mail-Message .o-mail-Composer-html.mashora-editor-editable"
        ),
    };
...
test("Update the link previews when a message is edited", async () => {
    ...
    await openDiscuss(channelId);
    await click(".o-mail-Message [title='Edit']");
    await insertText(".o-mail-Message .o-mail-Composer-input", "http://mashora.com", {
        replace: true,
    });
    await click(".o-mail-Message button", { text: "save" });
    await contains(".o-mail-Message-body", { text: "http://mashora.com" });
...
test("should delete link preview along with message", async () => {
    ...
    pyEnv["mail.message"].create({
        body: "<a href='https://www.mashora.com'>https://www.mashora.com</a>",
