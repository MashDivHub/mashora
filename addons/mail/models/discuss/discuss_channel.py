...
from mashora import _, api, fields, models, tools, Command
from mashora.addons.base.models.avatar_mixin import get_hsl_from_seed
...
from mashora.addons.mail.tools.web_push import PUSH_NOTIFICATION_TYPE
from mashora.exceptions import AccessError, UserError, ValidationError
from mashora.fields import Domain
from mashora.tools import format_list, email_normalize, html_escape
from mashora.tools.misc import hash_sign, OrderedSet
from mashora.tools.sql import SQL
...
class DiscussChannel(models.Model):
    ...
    def _get_access_action(self, access_uid=None, force_website=False):
        ...
        return {
            "type": "ir.actions.act_url",
            "url": f"/mashora/action-mail.action_discuss?active_id={self.id}",
            "target": "self",
        }
