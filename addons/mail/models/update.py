...
from mashora import api, fields, release, SUPERUSER_ID
from mashora.exceptions import UserError
from mashora.models import AbstractModel
...
class Publisher_WarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Mashora's publisher warranty server to check the
