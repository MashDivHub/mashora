...
Communicate with your colleagues/customers/guest within Mashora.
...
from Mashora itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Mashora system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Mashora documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Mashora integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Mashora, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_mashora_sfu': [
            'mail/static/lib/mashora_sfu/mashora_sfu.js',
        ],
        'mail.assets_lamejs': [
            'mail/static/lib/lame/lame.js',
        ],
        "mail.assets_message_email": [
            "web/static/lib/mashora_ui_icons/style.css",
        ],
        'mail.assets_public': [
