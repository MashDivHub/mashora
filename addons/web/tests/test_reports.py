...
class TestReports(mashora.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to Mashora, such as images,
    ...
    @mute_logger('mashora.addons.base.models.ir_actions_report')
