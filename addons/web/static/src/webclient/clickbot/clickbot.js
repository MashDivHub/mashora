...
import { App, reactive } from "@mashora/owl";
...
function setup(light, currentState) {
    env = mashora.__WOWL_DEBUG__.root.env;
    ...
    isEnterprise = mashora.info && mashora.info.isEnterprise;
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Mashora flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
