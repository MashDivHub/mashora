...
import { Component, useRef, useSubEnv } from "@mashora/owl";
 ...
 * It uses a feature to automatically create links to other mashora pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
