 ...
 */
export function mashoramark(text) {
    /**
     * Mapping of patterns - replacer functions to apply to mashoramarked strings.
     *
     ...
     *
     * Note: this list is declared inline in the `mashoramark` function to avoid other
