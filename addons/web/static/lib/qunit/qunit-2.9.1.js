...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("MashoraBeforeTestHook", "MashoraAfterTestHook"); // Mashora customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("MashoraBeforeTestHook"); // Mashora customization
  	...
  	finish: async function finish() {
  		...
  		emit("MashoraAfterTestHook", this);
