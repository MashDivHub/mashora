...
import { animationFrame } from "@mashora/hoot-dom";
import { App } from "@mashora/owl";
...
/**
 * @typedef {Parameters<typeof import("@mashora/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@mashora/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@mashora/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@mashora/owl").Component} target
 */
