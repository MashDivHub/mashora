...
/**
 * @typedef {import("@mashora/hoot").DragHelpers} DragHelpers
 * @typedef {import("@mashora/hoot").DragOptions} DragOptions
 * @typedef {import("@mashora/hoot").FillOptions} FillOptions
 * @typedef {import("@mashora/hoot").InputValue} InputValue
 * @typedef {import("@mashora/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@mashora/hoot").PointerOptions} PointerOptions
 * @typedef {import("@mashora/hoot").Position} Position
 * @typedef {import("@mashora/hoot").QueryOptions} QueryOptions
 * @typedef {import("@mashora/hoot").Target} Target
 *
 * @typedef {DragOptions & {
