import { after, afterEach, beforeEach, registerDebugInfo } from "@mashora/hoot";
 ...
 *
 * @param {Partial<MashoraEnv>} [partialEnv]
 * @param {{
 *  makeNew?: boolean;
 * }} [options]
 */
 ...
 *  (env: MashoraEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
