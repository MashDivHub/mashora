...
import { Deferred, animationFrame, runAllTimers } from "@mashora/hoot-mock";
...
test("many2one in non edit mode (with value)", async () => {
    ...
    expect("div[name=res_trululu] a.o_form_uri").toHaveAttribute("href", "/mashora/res.partner/1");
    expect("div[name=trululu] a.o_form_uri").toHaveAttribute("href", "/mashora/m-partner/4");
});
