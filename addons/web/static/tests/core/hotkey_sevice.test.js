import { destroy, expect, getFixture, onError, test } from "@mashora/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@mashora/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@mashora/hoot-mock";
import { Component, useRef, useState, xml } from "@mashora/owl";
import {
    contains,
    getService,
    makeMockEnv,
