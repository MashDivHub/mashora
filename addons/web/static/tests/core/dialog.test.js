import { destroy, expect, test } from "@mashora/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@mashora/hoot-dom";
import { animationFrame } from "@mashora/hoot-mock";
import { Component, onMounted, useState, xml } from "@mashora/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
