import { describe, destroy, expect, getFixture, test } from "@mashora/hoot";
import { click, tick } from "@mashora/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@mashora/hoot-mock";
