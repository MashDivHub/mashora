...
- `16.1`
  - The default payment instructions message of Wire Transfer can be recomputed at any time after
    installation of the module. mashora/mashora#103903
- `16.0`
  - The `custom_mode` field is added to distinguish custom payment modes from other payment
    ...
    mashora/mashora#99400
  - The module is no longer automatically installed with the `payment` module. mashora/mashora#99400
  - The module is renamed from `payment_transfer` to `payment_custom`. mashora/mashora#99400
