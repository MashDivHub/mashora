...
from mashora.tools import _, LazyTranslate, hash_sign
from mashora.exceptions import ValidationError, UserError
from mashora.addons.base.models.res_partner import EU_EXTRA_VAT_CODES
...
class ResPartner(models.Model):
    ...
    def _get_iap_vies_endpoint(self):
        prod, test = 'https://vies.api.mashora.com', 'https://vies.test.mashora.com'
