...
import { destroy, expect, getFixture } from "@mashora/hoot";
import { queryOne } from "@mashora/hoot-dom";
import { Component, markup, onWillDestroy, xml } from "@mashora/owl";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.mashora-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("mashora-editor-editable");
