...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    static dependencies = ["history", "position", "localOverlay", "collaborationMashora"];
    ...
    /**
     * @param {import("./collaboration_mashora_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerAvatar(selectionInfo) {
        ...
        const peerMetadata = this.dependencies.collaborationMashora.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
