...
/**
 * @typedef { Object } CollaborationMashoraShared
 * @property { CollaborationMashoraPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationMashoraPlugin extends Plugin {
    static id = "collaborationMashora";
        ...
        return new PeerToPeer({
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    case "ptp_remove":
                        // todo: to implement
                        // this.mashoraEditor.multiselectionRemove(notificationPayload);
                        break;
                    case "ptp_disconnect":
                        this.ptp.removePeer(fromPeerId);
                        // todo: to implement
                        // this.mashoraEditor.multiselectionRemove(fromPeerId);
                        break;
    ...
    async resetFromServerAndResyncWithPeers() {
        ...
        // lastHistoryId will be different if the mashora bus did not have time to
        // notify the user.
    ...
    showConflictDialog() {
        ...
        //     return;
        // }
        // const content = markup(this.mashoraEditor.editable.cloneNode(true).outerHTML);
