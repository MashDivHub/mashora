...
export class ColumnPlugin extends Plugin {
    ...
    resources = {
        ...
        hints: [
            {
                selector: `.mashora-editor-editable .o_text_columns div[class*='col-'],
                            .mashora-editor-editable .o_text_columns div[class*='col-']>${baseContainerGlobalSelector}:first-child`,
