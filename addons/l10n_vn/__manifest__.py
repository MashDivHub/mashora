# Part of Mashora. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.mashora.com/documentation/latest/applications/finance/fiscal_localizations/vietnam.html',
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This is the module to manage the accounting chart, bank information for Vietnam in Mashora.
========================================================================================
