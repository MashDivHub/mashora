...
from mashora import exceptions, fields
from mashora.exceptions import UserError
from mashora.fields import Command
from mashora.tests import Form, HttpCase, freeze_time, tagged
from mashora.tools import float_compare, float_repr, float_round

from mashora.addons.mrp.tests.common import TestMrpCommon
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see mashora/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/mashora/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/mashora/action-mrp.mrp_bom_form_action'
