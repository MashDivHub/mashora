...
from mashora.tests import Form, users
from mashora.tools.misc import format_date
from mashora.tests.common import HttpCase, tagged
...
class TestTourMrpOrder(HttpCase):
    def test_mrp_order_product_catalog(self):
        ...
        url = f'/mashora/action-mrp.mrp_production_action/{mo.id}'
    ...
    def test_manufacturing_and_byproduct_sm_to_sml_synchronization(self):
        ...
        url = f'/mashora/action-{action_id.id}/{mo.id}'
