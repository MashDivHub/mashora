...
from mashora.addons.base.tests.test_mimetypes import PNG
from mashora.addons.mail.tests.common import mail_new_test_user
from mashora.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('mashora.models', 'mashora.addons.base.models.ir_rule')
...
class TestAccessHttp(common.SlidesCase, HttpCase):
    @mute_logger('mashora.models', 'mashora.addons.base.models.ir_rule', 'mashora.http')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('mashora.models.unlink', 'mashora.addons.base.models.ir_rule', 'mashora.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("mashora.exceptions.ValidationError", res2.text)
