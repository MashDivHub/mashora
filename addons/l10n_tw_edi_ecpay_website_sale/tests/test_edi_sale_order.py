...
from mashora.addons.l10n_tw_edi_ecpay.tests.test_edi import L10nTWITestEdi
from mashora.tests import tagged


CALL_API_METHOD = 'mashora.addons.l10n_tw_edi_ecpay.utils.EcPayAPI.call_ecpay_api'
