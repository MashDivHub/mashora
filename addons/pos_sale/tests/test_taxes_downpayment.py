...
from mashora.addons.account.tests.test_taxes_downpayment import TestTaxesDownPayment
from mashora.addons.point_of_sale.tests.test_frontend import TestTaxCommonPOS
from mashora.addons.sale.tests.common import TestTaxCommonSale
