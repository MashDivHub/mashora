import { expect, queryAll, test } from "@mashora/hoot";
import {
    defineWebsiteModels,
...
import { click, queryOne } from "@mashora/hoot-dom";
...
test("add social medias", async () => {
    onRpc("website", "read", ({ args }) => {
        ...
        return [{ id: 1, social_facebook: "https://fb.com/mashora", social_twitter: false }];
    });
...
test("reorder social medias", async () => {
    onRpc("website", "read", ({ args }) => [
        { id: 1, social_facebook: "https://fb.com/mashora", social_twitter: "https://x.com/mashora" },
    ]);
    ...
    expect("tr [data-action-param='facebook'] input").toHaveValue("https://fb.com/mashora");
    expect("tr [data-action-param='twitter'] input").toHaveValue("https://x.com/mashora");
    ...
    expect("tr:nth-child(1) input[type=text]").toHaveValue("https://x.com/mashora");
    ...
    expect("tr:nth-child(4) input[type=text]").toHaveValue("https://fb.com/mashora");
    ...
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://x.com/mashora");
    ...
    expect("tr:nth-child(1) input[type=text]").toHaveValue("https://fb.com/mashora");
    expect("tr:nth-child(1) input[type=checkbox]").not.toBeChecked();
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://www.example.com/first");
    expect("tr:nth-child(3) input[type=text]").toHaveValue("https://x.com/mashora");
    ...
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://x.com/mashora");
    expect("tr:nth-child(2) input[type=checkbox]").toBeChecked();
    expect("tr:nth-child(3) input[type=text]").toHaveValue("https://fb.com/mashora");
    expect("tr:nth-child(3) input[type=checkbox]").not.toBeChecked();
    expect("tr:nth-child(4) input[type=text]").toHaveValue("https://www.example.com");
    ...
    expect("tr:nth-child(2) input[type=text]").toHaveValue("https://fb.com/mashora");
    expect("tr:nth-child(2) input[type=checkbox]").not.toBeChecked();
    expect("tr:nth-child(3) input[type=text]").toHaveValue("https://www.example.com/first");
    expect("tr:nth-child(4) input[type=text]").toHaveValue("https://www.example.com");
...
test("save social medias", async () => {
    ...
    await contains("div[data-action-param='facebook'] input").edit("https://facebook.com/Mashora");

    let writeCalled = false;
    onRpc("website", "write", ({ args }) => {
        expect(args[0]).toEqual([1]);
        expect(args[1]).toInclude(["social_facebook", "https://facebook.com/Mashora"]);
        expect(args[1]).toInclude(["social_twitter", "https://x.com/mashora"]);
        writeCalled = true;
        return true;
    });
