...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...addNewSocialNetwork(10, 9, "https://instagr.am/mashora.official/"),
        {
            ...
            trigger:
                ...
                ":has(a:eq(9)[href='https://instagr.am/mashora.official/']:has(i.fa-instagram))",
        },
        ...
        },
        {
            ...
            run: "edit https://instagram.com/mashora.official/ && click body",
        },
        ...preventRaceConditionStep,
        ...clickOnSave(),
        ...clickOnEditAndWaitEditMode(),
