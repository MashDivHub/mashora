...
import logging
from mashora import api, fields, models, modules
from mashora.tools.translate import xml_translate
from mashora.modules.module import get_resource_from_path

from mashora.addons.base.models.ir_asset import AFTER_DIRECTIVE, APPEND_DIRECTIVE, BEFORE_DIRECTIVE, DEFAULT_SEQUENCE, INCLUDE_DIRECTIVE, PREPEND_DIRECTIVE, REMOVE_DIRECTIVE, REPLACE_DIRECTIVE
