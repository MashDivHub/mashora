...
from mashora import api, fields, models, tools, release
from mashora.addons.website.models.ir_http import sitemap_qs2dom
from mashora.addons.website.tools import similarity_score, text_from_html, get_base_domain
from mashora.addons.portal.controllers.portal import pager
from mashora.addons.iap.tools import iap_tools
...
from mashora.modules.module import get_manifest
from mashora.tools import SQL, Query
from mashora.tools.image import image_process
from mashora.tools.sql import escape_psql
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.mashora.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.mashora.com'
...
class Website(models.Model):
        ...
        for model_name, field_name in self._get_html_fields():
            ...
            if dependency_records:
                ...
                dependencies[model_display_name] += [{
                    ...
                    'link': 'website_url' in rec and rec.website_url or f'/mashora/{model_name}/{rec.id}',
    ...
    def get_website_page_ids(self):
        ...
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Mashora framework works.
    ...
    def get_client_action_url(self, url, mode_edit=False, mode_debug=0):
        ...
        return "/mashora/action-website.website_preview?" + urls.url_encode(action_params)
