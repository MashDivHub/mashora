...
from mashora import tools, models, fields, api, _
...
from mashora.tools.mail import validate_url
...
class LinkTracker(models.Model):
    ...
    tracked by Mashora. Clicks are counter on each link. A tracker is linked to
