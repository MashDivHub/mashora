...
from mashora import models, fields, api

from mashora.exceptions import ValidationError

from mashora.addons.base_iban.models.res_partner_bank import validate_iban
...
class AccountJournal(models.Model):
    ...
    ], ondelete={'ch': lambda recs: recs.write({'invoice_reference_model': 'mashora'})})
