import { Component, EventBus, onWillDestroy, onWillStart, useState } from "@mashora/owl";
    ...
    start(env, { bus_service, dialog, presence }) {
        ...
        const checkIdentityErrorHandler = (env, error, originalError) => {
            if (originalError instanceof RPCError) {
                if (originalError.data.name === "mashora.addons.auth_timeout.models.ir_http.CheckIdentityException") {
                    run();
                    return true;
                }
            }
