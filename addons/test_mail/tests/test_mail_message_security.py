...
from mashora.addons.test_mail.models.mail_test_access import MailTestAccess
...
class TestMailMessageAccess(MessageAccessCommon):
    ...
    @mute_logger('mashora.addons.base.models.ir_model', 'mashora.addons.base.models.ir_rule')
