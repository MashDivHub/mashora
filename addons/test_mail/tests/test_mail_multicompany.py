...
from mashora.addons.test_mail.models.test_mail_corner_case_models import MailTestMultiCompanyWithActivity
from mashora.addons.test_mail.tests.common import TestRecipients
from mashora.exceptions import AccessError
from mashora.tests import tagged, users, HttpCase
from mashora.tests.common import JsonRpcException
...
class TestMultiCompanySetup(TestMailMCCommon, HttpCase):
    ...
    @users('employee_c2')
    @mute_logger('mashora.addons.base.models.ir_rule')
            ...
            with self.subTest(login=login, mc_record=mc_record):
                ...
                if not login:
                    ...
                    if mc_error:
                        ...
                        self.assertEqual(parsed_url.path, '/mashora/action-mail.action_discuss')
                    else:
