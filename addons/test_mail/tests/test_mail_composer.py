...
from mashora.addons.mail.wizard.mail_compose_message import MailComposeMessage
...
from mashora.fields import Datetime as FieldDatetime
from mashora.exceptions import AccessError, UserError
from mashora.tests import Form, tagged, users
from mashora.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('mashora.tests', 'mashora.addons.mail.models.mail_mail', 'mashora.models.unlink')
    ...
    @mute_logger('mashora.tests', 'mashora.addons.base.models.ir_rule', 'mashora.addons.mail.models.mail_mail', 'mashora.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('mashora.models.unlink', 'mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('mashora.models.unlink', 'mashora.addons.mail.models.mail_mail')
