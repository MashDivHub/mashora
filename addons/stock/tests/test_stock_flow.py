...
from mashora.tests import Form, HttpCase, tagged
from mashora.tests.common import users
from mashora.tools import mute_logger, float_round
...
class TestStockFlowTourPostInstall(TestStockCommon, HttpCase):
    ...
    def test_basic_stock_flow_with_minimal_access_rights(self):
        ...
        self.start_tour('/mashora', 'test_basic_stock_flow_with_minimal_access_rights', login='pauline')
