...
export class DonationOption extends BaseOptionComponent {
    ...
    // TODO AGAU: remove when merging https://github.com/mashora-dev/mashora/pull/4240
...
export class BaseDonationAction extends BuilderAction {
    getPrefilledOptionsList({ editingElement }) {
        ...
        // TODO AGAU: uncomment when merging https://github.com/mashora-dev/mashora/pull/4240
        // return savedOptions || "[]";
    }
