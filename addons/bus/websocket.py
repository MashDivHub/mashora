...
import mashora
from mashora import api, modules
from .models.bus import dispatch
from .tools import orjson
from mashora.http import root, Request, Response, SessionExpiredException, get_default_session
from mashora.modules.registry import Registry
from mashora.service import model as service_model
from mashora.service.server import CommonServer
from mashora.service.security import check_session
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if mashora.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('MASHORA_BUS_PUBLIC_SAMESITE_WS'):
            return
