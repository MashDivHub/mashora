...
import mashora.http
from mashora.tests import HOST, HttpCase
from mashora.tools import DotDict, config, frozendict
...
def MockRequest(
    ...
    request = Mock(
        ...
        type='http',
        future_response=mashora.http.FutureResponse(),
        params={},
        ...
        geoip=mashora.http.GeoIP('127.0.0.1'),
    ...
    if country_code or city_name:
        try:
            request.geoip._city_record = mashora.http.geoip2.models.City(['en'], country=(country_code and {'iso_code': country_code}) or {}, city=(city_name and {'names': {'en': city_name}}) or {})
        except TypeError:
            request.geoip._city_record = mashora.http.geoip2.models.City({'country': (country_code and {'iso_code': country_code}) or {}, 'city': (city_name and {'names': {'en': city_name}}) or {}})
    ...
    #
    #   router = mashora.http.root.get_db_router()
    ...
    with contextlib.ExitStack() as s:
        ...
        s.callback(mashora.http._request_stack.pop)
        s.enter_context(patch('mashora.http.root.get_db_router', router))
