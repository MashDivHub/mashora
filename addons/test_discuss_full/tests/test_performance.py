...
from mashora.tests.common import users, tagged, HttpCase, warmup
...
class TestDiscussFullPerformance(HttpCase, MailCommon):
    ...
    #   1: search res_partner (mashoraot ref exists)
    ...
    def setUp(self):
        ...
        with patch(
            "mashora.http.GeoIP.country_code",
    ...
    def _get_init_store_data_result(self):
        ...
        return {
            ...
            "Store": {
                ...
                "mashorabot": self.user_root.partner_id.id,
