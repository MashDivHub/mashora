...
Mashora on the success URL, a server-to-server API call is made to the
...
- The payload is matched to an Mashora transaction by reference (`orderId`).
...
- Refunds initiated from Mashora
- Express checkout
