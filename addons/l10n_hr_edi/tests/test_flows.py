...
from mashora.addons.account.tests.common import PatchRequestsMixin
from mashora.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from mashora.addons.l10n_hr_edi.tests.test_hr_edi_common import TestL10nHrEdiCommon
...
class TestHrEdiFlowsMocked(TestL10nHrEdiCommon, TestAccountMoveSendCommon, PatchRequestsMixin):
    ...
    def setUpClass(cls):
        ...
        company.write({
            ...
            'l10n_hr_mer_software_ident': 'Samashora-001',
