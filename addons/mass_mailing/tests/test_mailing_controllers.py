...
class TestMailingControllers(TestMailingControllersCommon):
    ...
    @mute_logger('mashora.http', 'mashora.addons.website.models.ir_ui_view')
...
class TestMailingTracking(TestMailingControllersCommon):
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.addons.mass_mailing.models.mailing')
