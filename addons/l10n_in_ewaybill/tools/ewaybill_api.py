...
from mashora.addons.l10n_in_ewaybill.models.error_codes import ERROR_CODES
from mashora.tools import _, LazyTranslate
...
class EWayBillError(Exception):
    ...
    def __init__(self, response):
        ...
        self.error_json.setdefault('mashora_warning', [])
    ...
    def _ewaybill_make_transaction(self, operation_type, json_payload):
        ...
        try:
            ...
            if "no-credit" in e.error_codes:
                e.error_json['mashora_warning'].append({
            ...
            if '238' in e.error_codes:
                ...
                # This happens when authenticate called from another mashora instance with same credentials
                # (like. Demo/Test)
            ...
            if operation_type == "cancel" and "312" in e.error_codes:
                ...
                response['mashora_warning'].append({
