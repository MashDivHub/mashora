...
TIMEOUT = 10
PEPPOL_PROXY_URLS = {
    'prod': 'https://peppol.api.mashora.com',
    'test': 'https://peppol.test.mashora.com',
}
...
class PeppolIAPConnector:
    ...
    def request_public_http(self, method, endpoint, data=None, params=None):
        ...
        try:
            ...
            _logger.debug("Failed to connect to Mashora Peppol Proxy %s, %s", endpoint, e)
            raise UserError(self.env._("Failed to connect to Mashora Peppol Proxy."))
