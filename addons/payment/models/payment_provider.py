...
from mashora.tools.mail import is_html_empty

from mashora.addons.payment import utils as payment_utils
from mashora.addons.payment.const import REPORT_REASONS_MAPPING, SENSITIVE_KEYS
...
class PaymentProvider(models.Model):
    ...
    capture_manually = fields.Boolean(
        ...
        help="Capture the amount from Mashora, when the delivery is completed.\n"
    ...
    support_refund = fields.Selection(
        string="Refund",
        help="Refund is a feature allowing to refund customers directly from the payment in Mashora.",
        selection=[
            ('none', "Unsupported"),
            ('full_only', "Full Only"),
    ...
    module_to_buy = fields.Boolean(string="Mashora Enterprise Module", related='module_id.to_buy')
