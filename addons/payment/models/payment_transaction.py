...
from mashora.tools import email_normalize_all, float_round

from mashora.addons.payment import utils as payment_utils
from mashora.addons.payment.const import CURRENCY_MINOR_UNITS, SENSITIVE_KEYS
...
class PaymentTransaction(models.Model):
    ...
    def _validate_amount(self, payment_data):
        ...
        # Negate the amount for refunds, as refunds have a negative amount in Mashora, but all
    ...
    def _send_api_request(self, method, endpoint, *, params=None, data=None, json=None, **kwargs):
        ...
        1. Pass the transaction reference to the provider's
           :meth:`~mashora.addons.payment.models.payment_provider.PaymentProvider._send_api_request`
           method.
