...
from mashora import _, api, models, release
from mashora.tools import format_amount

from mashora.addons.payment import utils as payment_utils
from mashora.addons.payment.logging import get_payment_logger
from mashora.addons.payment_adyen import const
            ...
            if source_tx:
                ...
                if source_tx.amount == converted_notification_amount:  # Full capture/void.
                    ...
                    if tx and tx.amount != converted_notification_amount:
                        ...
                        # others captures that Mashora was unaware of were done, the amount voided will
