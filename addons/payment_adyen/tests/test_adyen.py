...
from mashora.addons.payment import utils as payment_utils
from mashora.addons.payment.tests.http_common import PaymentHttpCommon
from mashora.addons.payment_adyen import utils as adyen_utils
from mashora.addons.payment_adyen.controllers.main import AdyenController
from mashora.addons.payment_adyen.tests.common import AdyenCommon
...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('mashora.addons.payment.models.payment_transaction'), \
            patch(
                'mashora.addons.payment.utils.generate_access_token',
        ...
        with patch(
            'mashora.addons.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('mashora.addons.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'mashora.addons.payment.models.payment_provider.PaymentProvider._send_api_request',
    ...
    def test_application_info_passed_in_payment_request(self):
        ...
        tx = self._create_transaction('direct')
        with (
            patch('mashora.addons.payment.utils.check_access_token', return_value='dummy_token'),
            patch(
                'mashora.addons.payment.models.payment_provider.PaymentProvider._send_api_request',
                return_value=dict(),
    ...
    @mute_logger('mashora.addons.payment_adyen.controllers.main')
    @mute_logger('mashora.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch('mashora.addons.payment_adyen.controllers.main.AdyenController._verify_signature'):
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(AdyenController._webhook_url)
        with patch(
            'mashora.addons.payment_adyen.controllers.main.AdyenController._verify_signature'
        ) as signature_check_mock, patch(
            'mashora.addons.payment.models.payment_transaction.PaymentTransaction._process'
        ):
