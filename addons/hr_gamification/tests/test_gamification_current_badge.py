...
class TestGamificationBadge(TestHrCommon):
    ...
    def setUpClass(cls):
        ...
        .create([
            {
                "name": "demo_user",
                "login": "demo@mashora.com",
                "email": "demo@mashora.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo2_user",
                "login": "demo2@mashora.com",
                "email": "demo2@mashora.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo3_user",
                "login": "demo3@mashora.com",
                "email": "demo3@mashora.com",
                "group_ids": [Command.link(cls.env.ref("base.group_user").id)],
            }, {
                "name": "demo4_manager",
                "login": "demo4@mashora.com",
                "email": "demo4@mashora.com",
