...
from mashora.addons.l10n_sa_edi.tests.common import AccountEdiTestCommon
...
class TestUi(TestGenericSAEdi):
    ...
    @patch('mashora.addons.l10n_sa_edi.models.account_journal.AccountJournal._l10n_sa_ready_to_submit_einvoices',
    ...
    @patch(
        "mashora.addons.l10n_sa_edi.models.account_journal.AccountJournal._l10n_sa_ready_to_submit_einvoices",
        new=lambda self: True,
    )
