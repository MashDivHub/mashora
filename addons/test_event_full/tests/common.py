...
from mashora.addons.base.tests.common import HttpCaseWithUserDemo, HttpCaseWithUserPortal
from mashora.addons.base.tests.test_ir_cron import CronMixinCase
from mashora.addons.event.tests.common import EventCase
from mashora.addons.event_crm.tests.common import EventCrmCase
from mashora.addons.mail.tests.common import mail_new_test_user, MailCase
from mashora.addons.sales_team.tests.common import TestSalesCommon
from mashora.addons.sms.tests.common import SMSCase
from mashora.addons.website.tests.test_website_visitor import MockVisitor
