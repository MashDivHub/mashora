...
from mashora.addons.crm.tests.common import TestCrmCommon
from mashora.addons.iap.tools import iap_tools
from mashora.tests.common import tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@mashora.com', 'fp@mashora.com'),
            ('fp.alias@mail.mashora.com', 'fp.alias@mail.mashora.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.mashora.com', 'subdomain.mashora.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@MASHORA.COM>',
                'name': 'Dupe1 of fp@mashora.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@mashora.com',
                'name': 'Dupe2 of fp@mashora.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.mashora.com',
                'name': 'Dupe3 of fp@mashora.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                'email_from': 'not.fp@not.mashora.com',
                'phone': '+1 202 555 0123',
                'name': 'Dupe4 of fp@mashora.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@mashora.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@mashora.com (same commercial entity)',
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@mashora.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@mashora.com')
