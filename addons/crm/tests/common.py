...
from mashora.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from mashora.addons.mail.tests.common import MailCase, mail_new_test_user
...
from mashora.fields import Datetime
from mashora import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('mashora.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
