...
from mashora.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('mashora.models.unlink', 'mashora.addons.crm.models.crm_team', 'mashora.addons.crm.models.crm_team_member')
