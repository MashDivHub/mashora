...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@mashora/o-spreadsheet";
...
/**
 * @typedef {import("@mashora/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@mashora/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class MashoraPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").MashoraEnv} env
     * @param {import("@spreadsheet").MashoraPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").MashoraGetters}
         */
    ...
    /**
     * Get the Mashora domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@mashora/o-spreadsheet").PivotDimension} dimension
