...
export class ListUIPlugin extends MashoraUIPlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            case "INSERT_MASHORA_LIST_WITH_TABLE": {
                this.dispatch("INSERT_MASHORA_LIST", cmd);
                this._addTable(cmd);
                break;
            }
            case "RE_INSERT_MASHORA_LIST_WITH_TABLE": {
                this.dispatch("RE_INSERT_MASHORA_LIST", cmd);
                this._addTable(cmd);
                break;
            }
        }
