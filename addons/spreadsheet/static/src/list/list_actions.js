...
import { astToFormula, helpers } from "@mashora/o-spreadsheet";
...
/**
 * @param {import("@mashora/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@mashora/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").MashoraGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "MASHORA.LIST"
    );
};
