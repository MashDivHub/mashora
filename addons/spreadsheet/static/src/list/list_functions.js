...
import { helpers, registries, EvaluationError } from "@mashora/o-spreadsheet";
...
functionRegistry.add("MASHORA.LIST", MASHORA_LIST);
functionRegistry.add("MASHORA.LIST.HEADER", MASHORA_LIST_HEADER);
