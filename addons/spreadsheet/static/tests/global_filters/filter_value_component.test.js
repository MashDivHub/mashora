...
import { click, queryAllTexts } from "@mashora/hoot-dom";
...
import { Component, onWillUnmount, xml } from "@mashora/owl";
...
test("basic text filter", async function () {
    ...
    const model = new Model({}, { custom: { mashoraDataProvider: new MashoraDataProvider(env) } });
