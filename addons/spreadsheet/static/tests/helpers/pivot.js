...
import { MashoraPivot } from "@spreadsheet/pivot/mashora_pivot";
...
async function insertStaticPivot(model, pivotId, params) {
    ...
    if (!(ds instanceof MashoraPivot)) {
        throw new Error("The pivot data source is not an MashoraPivot");
    }
 ...
 * @returns {Promise<{ model: MashoraSpreadsheetModel, env: object, pivotId: string}>}
 */
