...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('mashora.addons.mass_mailing.models.mailing', 'mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.mashora.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.mashora.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.mashora.be')
