from mashora.addons.l10n_ro_edi.tests.test_xml_ubl_ro import TestUBLROCommon
...
class TestUBLROCPVCode(TestUBLROCommon):
    ...
    def test_export_invoice(self):
        ...
        self._assert_invoice_attachment(attachment, xpaths=None, expected_file_path='from_mashora/ciusro_out_invoice_cpv_code.xml')
