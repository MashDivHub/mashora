...
import { click, queryAll, queryFirst } from "@mashora/hoot-dom";
        ...
        sheets: [
            {
                cells: {
                    ...
                    A2: { content: '=MASHORA.LIST(1, 1, "foo")' },
                },
            },
        ],
        lists: {
...
test("list sorting clickable cell", async () => {
    ...
    const data = {
        sheets: [
            {
                cells: {
                    A1: '=MASHORA.LIST.HEADER(1, "foo")',
                    A2: '=MASHORA.LIST(1, 1, "foo")',
                },
            },
        ],
        lists: {
        ...
        sheets: [
            {
                cells: {
                    ...
                    B1: "bar",
                    // spill cells
                    A2: "=MASHORA.LIST.HEADER(1, A1:B1)",
                    A3: '=MASHORA.LIST(1, sequence(2), "foo")',
                },
            },
        ],
        lists: {
