...
from mashora import Command, api, fields, models
from mashora.exceptions import UserError
from mashora.tools import float_compare, float_is_zero, float_repr, OrderedSet
...
class AccountMove(models.Model):
    ...
    def _l10n_pl_edi_get_status_mapping(self):
        """
        Returns a dictionary mapping KSeF status codes to (mashora_status, message).
        """
        return {
