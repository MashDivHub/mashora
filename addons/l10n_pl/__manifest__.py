# Part of Mashora. See LICENSE file for full copyright and licensing details.
{
    ...
    'countries': ['pl'],
    'version': '2.1',
    'author': 'Mashora, Grzegorz Grzelak (OpenGLOBE) (http://www.openglobe.pl)',
    'website': 'https://www.mashora.com/documentation/latest/applications/finance/fiscal_localizations.html',
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This is the module to manage the accounting chart and taxes for Poland in Mashora.
==================================================================================
...
Niniejszy moduł jest przeznaczony dla mashora 8.0.
