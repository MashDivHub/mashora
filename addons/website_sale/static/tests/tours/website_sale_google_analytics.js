...
function patchTracking() {
    const { Tracking } = mashora.loader.modules.get('@website_sale/interactions/tracking');
...
if (mashora.loader.modules.has('@website_sale/interactions/tracking')) {
    patchTracking();
} else {
    mashora.loader.bus.addEventListener('module-started', (e) => {
