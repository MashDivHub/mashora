...
from mashora.addons.mail_group.tests.data import GROUP_TEMPLATE
from mashora.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('mashora.models.unlink', 'mashora.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('mashora.addons.base.models.ir_rule', 'mashora.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.addons.mail_group.models.mail_group_message', 'mashora.models.unlink')
    @users('employee')
    ...
    @mute_logger('mashora.addons.mail_group.models.mail_group')
    @users('employee')
