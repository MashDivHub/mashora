...
from mashora.addons.base.models.ir_qweb_fields import nl2br
from mashora.addons.mail.tools.discuss import add_guest_to_context, Store
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/mashora_ui_icons', type='http', auth='none', cors="*")
    def mashora_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/mashora_ui_icons/fonts/mashora_ui_icons.woff2').get_response()
