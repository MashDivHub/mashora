...
from mashora.addons.im_livechat.tests import chatbot_common
from mashora.tests.common import JsonRpcException, new_test_user, tagged
from mashora.tools.misc import mute_logger
from mashora.addons.mail.tests.common import freeze_all_time, MailCommon
...
class ChatbotCase(MailCommon, chatbot_common.ChatbotCase):
    ...
    def test_chatbot_steps(self):
        ...
        with self.assertRaises(JsonRpcException, msg='mashora.exceptions.ValidationError'), mute_logger("mashora.http"):
    ...
    def test_forward_to_specific_operator(self):
                            ...
                            "discuss.channel": [
                                {
                                    ...
                                    "name": "MashoraBot Ernest Employee",
                                },
                            ],
                            "res.partner": self._filter_partners_fields(
                                {
        ...
        self.assertEqual(discuss_channel.name, "MashoraBot Ernest Employee")
    ...
    def test_chatbot_clear_answers_on_step_type_change(self):
        ...
        self.start_tour(f"/mashora/action-{action.id}", 'change_chatbot_step_type', login='admin')
