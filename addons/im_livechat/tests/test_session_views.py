...
from mashora.tests.common import users, tagged
...
class TestImLivechatSessionViews(TestImLivechatCommon):
    def test_session_history_navigation_back_and_forth(self):
        ...
        self.start_tour(
            f"/mashora/livechat/{self.livechat_channel.id}/action-{action.id}",
...
class TestImLivechatLookingForHelpViews(TestImLivechatSessionViews):
    ...
    def test_looking_for_help_list_real_time_update(self):
        ...
        self.start_tour(
            f"/mashora/action-{self.looking_for_help_action.id}",
    ...
    def test_looking_for_help_kanban_real_time_update(self):
        self.start_needhelp_session()
        self.start_tour(
            f"/mashora/action-{self.looking_for_help_action.id}?view_type=kanban",
    ...
    def test_looking_for_help_discuss_category(self):
        ...
        self._reset_bus()
        self.start_tour(
            "/mashora/discuss", "im_livechat.looking_for_help_discuss_category_tour", login="agent"
        )
