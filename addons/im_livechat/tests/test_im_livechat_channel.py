...
from mashora.addons.im_livechat.tests.test_get_operator import TestGetOperator
...
class TestImLivechatChannel(TestImLivechatCommon, TestGetOperator):
    ...
    def test_review_link(self):
        ...
        self.livechat_channel.review_link = "https://www.mashora.com"
        self.assertEqual(self.livechat_channel.review_link, "https://www.mashora.com")
