...
import { click, edit, keyDown, keyUp, press, queryOne } from "@mashora/hoot-dom";
...
test("Click on element with unique mashora class", async () => {
...
test("Click on element with no unique mashora class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest mashora class", async () => {
