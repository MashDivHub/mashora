import { beforeEach, describe, expect, test, waitUntil } from "@mashora/hoot";
...
const expectedDateTimeMessage =
    '<AdjustTimeRequest><Id>MashoraPos</Id><SeqNo>00000000000</SeqNo><Date year="2019" month="3" day="11"/><Time hour="10" minute="30" second="0"/></AdjustTimeRequest>\0';
const expectedGetStatusMessage =
    '<StatusRequest><Id>MashoraPos</Id><SeqNo>00000000000</SeqNo><RequireVerification type="1"/></StatusRequest>\0';
const expectedGetInventoryMessage =
    '<InventoryRequest><Id>MashoraPos</Id><SeqNo>00000000000</SeqNo><Option type="2"/></InventoryRequest>\0';
