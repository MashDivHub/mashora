...
from mashora.tests import HttpCase, freeze_time, tagged, new_test_user
...
class TestEmployeeUi(HttpCase):
    def test_employee_profile_tour(self):
        ...
        self.start_tour("/mashora", 'hr_employee_tour', login="davidelora")
    ...
    def test_version_timeline_auto_save_tour(self):
        ...
        self.start_tour("/mashora", 'version_timeline_auto_save_tour', login="alice")
