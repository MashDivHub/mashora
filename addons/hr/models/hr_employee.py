...
from mashora import api, fields, models, _, tools
from mashora.fields import Domain
from mashora.exceptions import ValidationError, AccessError, RedirectWarning, UserError
from mashora.tools import convert, format_time, email_normalize, SQL, Query
from mashora.tools.intervals import Intervals
from mashora.addons.hr.models.hr_version import format_date_abbr
from mashora.addons.mail.tools.discuss import Store
from mashora.tools.float_utils import float_is_zero
...
class HrEmployee(models.Model):
    ...
    def _check_access(self, operation):
        ...
        # Since Mashora 19, one must have read access to the comodel to modify the
        # relation.
...
We can redirect you to the public employee list."""
    ...
    def create(self, vals_list):
        ...
        for employee in employees:
            ...
            url = '/mashora/%s/action-hr.plan_wizard_action?active_model=hr.employee&menu_id=%s' % (employee.id, hr_root_menu.id)
