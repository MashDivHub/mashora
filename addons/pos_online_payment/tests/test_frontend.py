...
from mashora.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from mashora.addons.mail.tests.common import mail_new_test_user
from mashora.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from mashora.addons.account.models.account_payment_method import AccountPaymentMethod
from mashora.addons.point_of_sale.tests.common import archive_products
...
class TestUi(TestPointOfSaleHttpCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('mashora.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
