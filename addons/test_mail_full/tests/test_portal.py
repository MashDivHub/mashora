...
from mashora.addons.auth_signup.models.res_partner import ResPartner
from mashora.addons.mail.tests.common import MailCommon
from mashora.addons.test_mail_full.tests.common import TestMailFullCommon
from mashora.addons.test_mail_sms.tests.common import TestSMSRecipients
from mashora.exceptions import AccessError
from mashora.tests import tagged, users
from mashora.tests.common import HttpCase
from mashora.tools import html_escape, mute_logger
...
class TestPortalControllers(TestPortal):
    ...
    def test_portal_share_comment(self):
        ...
        # Only messages from the current user not MashoraBot
...
class TestPortalFlow(MailCommon, HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.internal_backend_local_url = f'/mashora/{cls.record_internal._name}/{cls.record_internal.id}'
        cls.portal_backend_local_url = f'/mashora/{cls.record_portal._name}/{cls.record_portal.id}'
        cls.read_backend_local_url = f'/mashora/{cls.record_read._name}/{cls.record_read.id}'
        cls.public_act_url_backend_local_url = f'/mashora/{cls.record_public_act_url._name}/{cls.record_public_act_url.id}'
        cls.discuss_local_url = '/mashora/action-mail.action_discuss'
