...
from mashora.tools import make_index_name, SQL
from mashora.tools.translate import TranslationImporter
from mashora.tests import standalone
from mashora.addons.account.models.chart_template import AccountChartTemplate
...
def test_all_l10n(env):
    ...
    logger = logging.getLogger('mashora.loading')
