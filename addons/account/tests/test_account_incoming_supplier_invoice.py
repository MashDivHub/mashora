...
from mashora.tests import tagged, RecordCapturer
...
from mashora.addons.test_mimetypes.tests.test_guess_mimetypes import contents
...
class TestAccountInvoiceImportMixin:
    ...
    def assert_attachment_import(self, origin, attachments_vals, expected_invoices):
        """ Simulate the upload and import of one or more attachments and assert that the
            ...
            :param attachments_vals: A list of values representing the attachments to be uploaded to Mashora
    ...
    def _upload_and_import_attachments(self, origin, attachments_vals):
        """ Simulate the upload of one or more attachments and their processing by the import framework.
            ...
            :param origin: The source from which the attachments should be introduced into Mashora.
                           Possible values:
            ...
            :param attachments_vals: A list of values representing attachments to upload into Mashora.
...
class TestAccountIncomingSupplierInvoice(AccountTestInvoicingCommon, TestAccountInvoiceImportMixin, MailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.internal_user = cls._create_new_internal_user(login='internal.user@test.mashora.com')
    ...
    def test_import_with_traceback(self):
        ...
        with (
            ...
            patch('mashora.addons.account.models.partner.ResPartner.search', side_effect=ValueError('We want to test an unexpected error')),
            mute_logger('mashora.addons.account.models.account_document_import_mixin'),
        ):
