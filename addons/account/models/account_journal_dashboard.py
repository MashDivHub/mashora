...
from mashora import models, api, _, fields, tools
from mashora.exceptions import UserError
from mashora.fields import Command, Domain
from mashora.release import version
from mashora.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from mashora.tools.misc import formatLang, format_date as mashora_format_date, get_lang
...
class AccountJournal(models.Model):
    ...
    def _transform_activity_dict(self, activity_data):
        return {
            ...
            'date': mashora_format_date(self.env, activity_data['date_deadline']),
        }
