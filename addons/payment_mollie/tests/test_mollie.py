...
from mashora.addons.payment_mollie.controllers.main import MollieController
from mashora.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'mashora.addons.payment_mollie.controllers.main',
        'mashora.addons.payment_mollie.models.payment_transaction',
    )
