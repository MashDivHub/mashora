...
from mashora import _, Command
from mashora.exceptions import UserError, RedirectWarning, AccessError
from mashora.tests import tagged
from mashora.tools import zeep
...
class TestL10nEsEdiVerifactuDocument(TestL10nEsEdiVerifactuCommon):
    ...
    def test_generation_error(self):
        check_function_path = 'mashora.addons.l10n_es_edi_verifactu.models.verifactu_document.L10nEsEdiVerifactuDocument._check_record_values'
