import { Component, onWillStart } from "@mashora/owl";
...
export class TestEPos extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            mashora.use_lna = (await this.orm.call("pos.printer", "use_local_network_access")).use_lna;
        });
    }
    ...
    async onClick() {
        try {
            ...
            const protocol = mashora.use_lna ? "http:" : window.location.protocol;
