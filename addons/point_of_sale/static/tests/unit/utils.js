...
import { animationFrame, tick, waitFor, waitUntil } from "@mashora/hoot-dom";
import { Deferred } from "@mashora/hoot-mock";
import { MainComponentsContainer } from "@web/core/main_components_container";
import { patch } from "@web/core/utils/patch";
import { onMounted } from "@mashora/owl";
import { expect } from "@mashora/hoot";
...
export const setupPosEnv = async () => {
    ...
    mashora.pos_session_id = 1;
    mashora.pos_config_id = 1;
    mashora.from_backend = 0;
    mashora.access_token = uuidv4(); // Avoid indexedDB conflicts
    mashora.info = {
