...

{
    ...
    'installable': True,
    'application': True,
    'website': 'https://www.mashora.com/app/point-of-sale-shop',
    'assets': {
        ...
        'point_of_sale.base_app': [
            ...
            "web/static/lib/mashora_ui_icons/*",
            "point_of_sale/static/src/utils.js",
        ...
        'point_of_sale._assets_pos': [
            ...
            'web/static/lib/owl/mashora_module.js',
        ...
        'point_of_sale.customer_display_assets': [
            ('include', 'point_of_sale.base_app'),
            "point_of_sale/static/src/app/components/mashora_logo/*",
