...
[Contact Info](https://www.mashora.com/security-report)
...
Our [Responsible Disclosure](https://www.mashora.com/security-report) page gives an overview of the
process, including:
...
We receive a majority of security reports that have little to no impact on the security of Mashora or
the Mashora Cloud, and we ultimately have to reject them. To avoid a disappointing experience when
...
Also be sure to review our list of [non-qualifying issues](https://www.mashora.com/security-report#what).
