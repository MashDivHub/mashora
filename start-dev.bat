...
:: Start backend
start "Mashora Backend" cmd /k "cd /d %~dp0app\backend && pip install -r requirements.txt -q 2>nul && echo. && echo [Backend] Port 8002 && echo. && uvicorn app.main:app --host 0.0.0.0 --port 8002 --reload"
