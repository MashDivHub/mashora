...
export default function BlogPost() {
  ...
  if (isLoading) return <div className="mx-auto max-w-4xl px-6 py-10 text-muted-foreground">Loading...</div>
  if (!post) return <div className="mx-auto max-w-4xl px-6 py-10">Post not found.</div>
