"""Permissions management: Groups, ACL, Record Rules."""
...
from app.services.base import async_search_read, async_get_or_raise, async_update
...
async def get_group(group_id: int, user: CurrentUser = Depends(get_current_user)):
    """Get group detail with users and implied groups."""
