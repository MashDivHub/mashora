...
from mashora.exceptions import AccessError, UserError, MissingError
from mashora.tools import SQL, OrderedSet, is_list_of, html_sanitize
from mashora.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like Mashora fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~mashora.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~mashora.fields.Properties`
