...
from mashora.exceptions import AccessError, MissingError, UserError
from mashora.tools import SQL, OrderedSet, Query, sql, unique
from mashora.tools.constants import PREFETCH_MAX
from mashora.tools.misc import SENTINEL, Sentinel, unquote
...
if typing.TYPE_CHECKING:
    ...
    from mashora.tools.misc import Collector
...
class Many2one(_Relational):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~mashora.models.Model._check_company`. Has a different behaviour
...
class Many2many(_RelationalMulti):
    ...
    :param bool check_company: Mark the field to be verified in
        :meth:`~mashora.models.Model._check_company`. Add a default company
