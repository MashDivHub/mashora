...
from mashora.tools import Query, SQL, reset_cached_properties, sql
from mashora.tools.constants import PREFETCH_MAX
from mashora.tools.misc import SENTINEL, ReadonlyDict, Sentinel, unique
...
_logger = logging.getLogger('mashora.fields')
...
class Field(typing.Generic[T]):
    ...
    def _get_attrs(self, model_class: type[BaseModel], name: str) -> dict[str, typing.Any]:
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since Mashora 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, stacklevel=2)
