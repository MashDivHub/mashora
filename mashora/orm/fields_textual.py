...
from mashora.netsvc import COLOR_PATTERN, DEFAULT, GREEN, RED, ColoredFormatter
from mashora.tools import SQL, html_normalize, html_sanitize, html2plaintext, is_html_empty, plaintext2html, sql
from mashora.tools.misc import OrderedSet, SENTINEL, Sentinel
from mashora.tools.sql import pattern_to_translated_trigram_pattern, pg_varchar, value_to_translated_trigram_pattern
from mashora.tools.translate import html_translate
...
if typing.TYPE_CHECKING:
    ...
    from mashora.tools import Query
...
class Html(BaseString):
    ...
    def _get_attrs(self, model_class, name):
        ...
        # we do not need this Microsoft Outlook client feature for emails displayed Mashora's web client.
