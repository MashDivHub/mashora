...
QWeb is the primary templating engine used by Mashora. It is an XML templating
...
<https://www.mashora.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed mashora user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Mashora method from ``res.users`` model.
...
from mashora.modules.registry import _REGISTRY_CACHES
from mashora.tools import config, safe_eval, OrderedSet, frozendict, json
from mashora.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from mashora.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from mashora.tools.lru import LRU
from mashora.tools.misc import str2bool, file_open, file_path
from mashora.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from mashora.tools.profiler import ExecutionContext
from mashora.tools.translate import FORMAT_REGEX
from mashora.http import request
from mashora.tools.profiler import QwebTracker
from mashora.exceptions import UserError, MissingError

from mashora.addons.base.models.assetsbundle import AssetsBundle
from mashora.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _render_iterall(self, view_ref, method, values, directive='render') -> Iterator[str]:
        ...
        try:
            ...
            if hasattr(error, 'qweb'):
                ...
                # If is not an mashora Exception check if the current error is raise from
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Mashora 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__mashoraAssetError=1"
