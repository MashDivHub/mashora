...
from mashora import api, Command, fields, models
from mashora.tools import OrderedSet
from mashora.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an mashora
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`mashora.models.Model.write` expects.

        :param model: :class:`mashora.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`mashora.fields.Field`
