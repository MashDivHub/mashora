...
from mashora.tests.common import BaseCase, HttpCase
from mashora.tests.test_cursor import TestCursor
from mashora.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('mashora.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:mashora.sql_db:Found different un-closed cursor', msg)
