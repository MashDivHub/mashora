...
from mashora import Command, models
from mashora.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from mashora.addons.base.models.res_partner import ResPartner
from mashora.addons.base.tests.common import TransactionCaseWithUserDemo
from mashora.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from mashora.tests import Form
from mashora.tests.common import new_test_user, tagged, TransactionCase, users
...
class TestPartner(TransactionCaseWithUserDemo):
    ...
    def test_main_user_id(self):
        """Test main_user_id compute, including MashoraBot special case and priority among several users."""
