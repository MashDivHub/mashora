...
from mashora.tests import BaseCase, TransactionCase, tagged, BaseCase
from mashora.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when MASHORA_TEST_FAILURE_RETRIES is set"""
