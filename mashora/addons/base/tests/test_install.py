...
from mashora.tests.common import standalone
from mashora.tests.test_module_operations import install
from mashora.tools import mute_logger
from mashora.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('mashora.modules.registry'):
