...
from mashora.tests import Form, TransactionCase, users
from mashora.tools import get_lang, mute_logger
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('mashora.models.unlink', 'mashora.fields')
    ...
    @users('test')
    @mute_logger('mashora.addons.base.models.ir_rule', 'mashora.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('mashora.addons.test_orm.models.test_orm.TestOrmMultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('mashora.addons.test_orm.models.test_orm.TestOrmDiscussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('mashora.fields', 'mashora.models.unlink')
