...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/mashora/action-test_orm.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@mashora.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(mashora.tests.HttpCase):

    @mute_logger('mashora.sql_db', 'mashora.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/mashora/action-test_orm.action_categories",
