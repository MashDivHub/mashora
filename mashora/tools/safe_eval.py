...
_BUBBLEUP_EXCEPTIONS = (
    mashora.exceptions.UserError,
    mashora.exceptions.RedirectWarning,
...
`mashora.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `mashora.tools.safe_eval`.
""")
    return d
...
from mashora._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
