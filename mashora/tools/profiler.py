...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching Mashora.
    """
    name = 'traces_sync'
    ...
    def end(self):
        ...
        try:
            ...
            if self.db:
                ...
                from mashora.sql_db import db_connect  # only import from mashora if/when needed.
