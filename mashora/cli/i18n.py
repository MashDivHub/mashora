...
from mashora.cli.command import Command
from mashora.fields import Domain
from mashora.modules import get_module_path
from mashora.modules.registry import Registry
from mashora.tools import OrderedSet, config
from mashora.tools.translate import TranslationImporter, load_language, trans_export
    ...
    def __init__(self, *args, **kwargs):
        ...
        for parser in (self.import_parser, self.export_parser, self.loadlang_parser):
            ...
            parser.epilog = textwrap.dedent("""\
                ...
                Examples:
                    mashora-bin i18n loadlang -l en         # English (U.S.)
                    mashora-bin i18n loadlang -l es es_AR   # Spanish (Spain, Argentina)
                    mashora-bin i18n loadlang -l sr@latin   # Serbian (Latin)
            """)
