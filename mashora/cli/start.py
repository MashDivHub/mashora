...
from mashora.modules.module import Manifest, MANIFEST_NAMES
from mashora.service.db import _create_empty_database, DatabaseExists
from mashora.tools import config


class Start(Command):
    """ Quickly start the mashora server with default options """
