...
from mashora.modules.loading import force_demo
from mashora.modules.module import get_module_path, initialize_sys_path
from mashora.modules.registry import Registry
from mashora.tools import OrderedSet, config, parse_version
...
class Module(Command):
    ...
    def __init__(self, *args, **kwargs):
        ...
        install_parser.epilog = textwrap.dedent("""\
            Before installing modules, an Mashora database needs to be created and initialized
            on your PostgreSQL instance, using the `db init` command:

            $ mashora-bin db init <db_name>

            To get help on its parameters, see:

            $ mashora-bin db init --help
        """)
