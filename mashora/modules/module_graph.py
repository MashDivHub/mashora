...
from mashora.tools import reset_cached_properties, OrderedSet
...
class ModuleNode:
    """
    Loading and upgrade info for an Mashora module
    """
...
class ModuleGraph:
    """
    Sorted Mashora modules ordered by (module.phase, module.depth, module.name)
    """
