...
from mashora.tools.safe_eval import _UNSAFE_ATTRIBUTES
...
def retrying(func, env):
    ...
    :param mashora.api.Environment env: The environment where the registry
