...
This tool provides utilities to duplicate records across models in Mashora, while maintaining referential integrity,
...
from mashora.fields import Field, Many2one
