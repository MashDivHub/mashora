...
Mashora will use the SQL function 'unaccent' when available for the
...
import mashora.orm.domains as orm_domains
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use mashora.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return mashora.modules.registry.Registry(cr.dbname).unaccent
