...
"""The Mashora API module defines Mashora Environments.
"""
...
from mashora.exceptions import AccessError, UserError, CacheMiss
from mashora.sql_db import BaseCursor
from mashora.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from mashora.tools.translate import get_translation, get_translated_module, LazyGettext
from mashora.tools.misc import StackMap, SENTINEL
...
_logger = logging.getLogger('mashora.api')
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~mashora.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~mashora.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~mashora.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~mashora.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in mashora.tools.file_open_temporary_directory)
