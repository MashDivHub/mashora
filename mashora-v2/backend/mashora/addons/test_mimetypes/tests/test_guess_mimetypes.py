...
from mashora.tools.mimetypes import _mashora_guess_mimetype, guess_mimetype
...
class TestMimeGuessingMashora(BaseCase, MimeGuessingCases):
    guess_mimetype = staticmethod(_mashora_guess_mimetype)
...
@unittest.skipIf(guess_mimetype is _mashora_guess_mimetype, "python-magic not installed")
