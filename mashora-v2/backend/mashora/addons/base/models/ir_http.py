...
import mashora
from mashora import api, http, models, tools
from mashora.api import SUPERUSER_ID
from mashora.exceptions import AccessDenied
from mashora.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from mashora.modules.registry import Registry
from mashora.service import security
from mashora.tools.json import json_default
from mashora.tools.misc import get_lang, submap
from mashora.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and mashora.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (mashora.exceptions.AccessError, mashora.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, mashora.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(mashora.tools.config['server_wide_modules'])
    ...
    def _gc_sessions(self):
        if os.getenv("MASHORA_SKIP_GC_SESSIONS"):
            return
