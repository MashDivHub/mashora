...
from mashora.exceptions import AccessDenied, UserError, ValidationError
from mashora.fields import Domain
from mashora.tools import config
from mashora.tools.parse_version import parse_version
from mashora.tools.misc import topological_sort, get_flag
from mashora.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from mashora.http import request
from mashora.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Mashora Enterprise Edition License v1.0'),
        ('OPL-1', 'Mashora Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Mashora Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        if self.search_count([('state', 'in', ('to install', 'to upgrade', 'to remove'))], limit=1):
            raise UserError(_("Mashora is currently processing another module operation.\n"
        ...
        try:
            ...
            raise UserError(_("Mashora is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(mashora.tools.config['server_wide_modules']) & set(self.mapped('name'))
