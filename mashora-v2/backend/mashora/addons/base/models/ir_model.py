...
from mashora import api, fields, models, tools
from mashora.exceptions import AccessError, UserError, ValidationError
from mashora.fields import Command, Domain
from mashora.tools import frozendict, reset_cached_properties, split_every, sql, unique, OrderedSet, SQL
from mashora.tools.safe_eval import safe_eval, datetime, dateutil, time
from mashora.tools.translate import FIELD_TRANSLATE, LazyTranslate, _
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in mashora.modules.loading.
...
class IrModelFields(models.Model):
    ...
    def _drop_column(self):
        from mashora.orm.model_classes import pop_field
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('translate') and not isinstance(vals['translate'], str):
                _logger.warning("Deprecated since Mashora 19, ir.model.fields.translate becomes Selection, the value should be a string")
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Mashora many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Mashora
    ...
    def _module_data_uninstall(self, modules_to_remove):
        ...
        """
        from mashora.orm.model_classes import add_field
