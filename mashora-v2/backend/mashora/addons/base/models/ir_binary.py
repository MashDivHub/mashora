...
from mashora.exceptions import MissingError, UserError
from mashora.http import Stream, request
from mashora.tools import file_open, replace_exceptions
from mashora.tools.image import image_guess_size_from_field_name, image_process
from mashora.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from mashora.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:mashora.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~mashora.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`mashora.tools.image.image_process`.
