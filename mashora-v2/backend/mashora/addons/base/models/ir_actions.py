...
from mashora.tools import _, frozendict, get_lang
from mashora.tools.float_utils import float_compare
from mashora.tools.misc import get_diff, unquote
from mashora.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since Mashora 8.0 a button 'Create Menu Action' button is available on the
