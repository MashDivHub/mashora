...
class TestGraph(BaseCase):
    @mute_logger('mashora.modules.module_graph')
    def _test_graph_order(
        ...
        with (
            patch('mashora.modules.module_graph.ModuleGraph._update_from_database'),
            patch('mashora.modules.module_graph.Manifest.for_addon', make_manifest),
            patch('mashora.modules.module_graph.ModuleGraph._imported_modules', {'studio_customization'}),
        ):
            dummy_cr = None
