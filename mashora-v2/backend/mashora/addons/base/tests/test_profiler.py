...
from mashora.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from mashora.tools import profiler
from mashora.tools.profiler import Profiler, ExecutionContext
from mashora.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('mashora.sql_db.db_connect', return_value=self.registry))
