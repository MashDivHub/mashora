...
from mashora.tools.pdf.signature import PdfSigner
...
class TestSignature(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cert_subject = x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Mashora"),
            x509.NameAttribute(NameOID.COMMON_NAME, "mashora.com")
        ])
    ...
    def test_mashora_pdf_signer(self):
