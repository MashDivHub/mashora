...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('mashora.http'):
    ...
    def test_01_create(self):
        ...
        with self.assertRaises(Fault) as ctx, mute_logger("mashora.sql_db", "mashora.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("mashora.sql_db"), self.assertLogs("mashora.http", level="WARNING") as capture:
