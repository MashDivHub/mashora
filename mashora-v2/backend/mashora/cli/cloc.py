...
from mashora.tools import cloc, config
from . import Command
...
class Cloc(Command):
    ...
    description = """
        Mashora cloc is a tool to count the number of relevant lines written
        ...
        It has two modes of operation, either by providing a path:
            ...
            mashora-bin cloc -p module_path

        Or by providing the name of a database:

            mashora-bin --addons-path=dirs cloc -d database
