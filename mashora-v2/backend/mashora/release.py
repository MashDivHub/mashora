...
product_name = 'Mashora'
description = 'Mashora Server'
long_desc = '''Mashora is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'Mashora'
author_email = 'info@mashora.com'
license = 'LGPL-3'

nt_service_name = "mashora-server-" + series.replace('~','-')
