# -*- coding: utf-8 -*-
"""
The module :mod:`mashora.tests.form` provides an implementation of a client form
...
from mashora import api, fields
...
class Form:
    ...
    * properly handle defaults & onchanges around x2many fields.
    ...
    of :class:`~mashora.fields.Many2one` fields, one can assign a recordset::
    ...
    For :class:`~mashora.fields.Many2many` fields, the field itself is a
    :class:`~mashora.tests.common.M2MProxy` and can be altered by adding or
    removing records::
    ...
    Finally :class:`~mashora.fields.One2many` are reified as :class:`~O2MProxy`.

    Because the :class:`~mashora.fields.One2many` only exists through its parent,
...
class O2MProxy(X2MProxy):
    ...
    def new(self):
        ...
        :class:`~mashora.fields.One2many` record, properly initialised.
    ...
    def edit(self, index):
        ...
        :class:`~mashora.fields.One2many` record.
