...
from mashora.addons.gamification.tests.common import TransactionCaseGamification
...
class test_challenge(TestGamificationCommon):
    ...
    @mute_logger('mashora.models.unlink', 'mashora.addons.mail', 'mashora.addons.auth_signup')
