...
from mashora import _, api, exceptions, fields, models
from mashora.exceptions import LockError, MissingError
from mashora.fields import Domain
from mashora.http import request
from mashora.tools import safe_eval
...
def _get_domain_fields(env, model, domain):
    ...
    # see: https://github.com/mashora/mashora/pull/189772#issuecomment-2548804283
