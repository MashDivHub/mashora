...
from mashora.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@mashora.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(mashora.tests.HttpCase):
    def test_tour(self):
        ...
        with mashora.tests.RecordCapturer(self.env['hr.applicant']) as capt:
