...
from mashora.tests import Form, common
from mashora.tools import float_compare, mute_logger

from mashora.addons.sale.tests.common import TestSaleCommon
from mashora.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import (
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('mashora.tests.common.onchange')
