...
from mashora.http import JsonRPCDispatcher, serialize_exception
...
if not IS_TEST:
    # Test IoT system is expected to handle Mashora database unlike "real" IoT systems.

    def db_list(force=False, host=None):
        return []

    mashora.http.db_list = db_list
