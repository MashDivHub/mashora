...
from mashora import api, models, _
...
class SurveySurvey(models.Model):
    ...
    def _prepare_assessment_template_values(self):
        survey_values = {
            ...
            'description': ''.join([
                _('Welcome to this Mashora certification. You will receive 2 random questions out of a pool of 3.'),
            ...
            'question_and_page_ids': [
                (0, 0, {  # survey.question
                    'title': _('Mashora Certification'),
                    'is_page': True,
                    'question_type': False,
                    'random_questions_count': 2
                }),
                (0, 0, {  # survey.question
                    'title': _('What does "MASHORA" stand for?'),
                    'question_type': 'simple_choice',
                    'suggested_answer_ids': [
                        (0, 0, {  # survey.question.answer
                ...
                (0, 0, {  # survey.question
                    'title': _('What does one need to get to pass an Mashora Survey?'),
                    'question_type': 'simple_choice',
                    'suggested_answer_ids': [
                        (0, 0, {  # survey.question.answer
