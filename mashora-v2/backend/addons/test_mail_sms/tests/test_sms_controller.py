...
from mashora.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
...
class TestSmsController(TestSMSActionsCommon):
    ...
    @mute_logger("mashora.addons.base.models.ir_http")
    ...
    @mute_logger('mashora.addons.base.models.ir_http', 'mashora.addons.sms.controllers.main', 'mashora.http')
