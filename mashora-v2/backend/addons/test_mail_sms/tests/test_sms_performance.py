...
from mashora.addons.sms.tests import common as sms_common
from mashora.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('mashora.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
