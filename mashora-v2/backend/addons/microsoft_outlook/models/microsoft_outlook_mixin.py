...
from mashora.tools import hmac, email_normalize
from mashora.tools.urls import urljoin as url_join
from mashora.addons.google_gmail.tools import get_iap_error_message
...
class MicrosoftOutlookMixin(models.AbstractModel):
    ...
    _OUTLOOK_SCOPE = None
    _DEFAULT_OUTLOOK_IAP_ENDPOINT = 'https://outlook.api.mashora.com'
