...
from mashora import _, api, fields, models, tools, SUPERUSER_ID
from mashora.addons.account_edi_ubl_cii.models.account_edi_common import SUPPORTED_FILE_TYPES
from mashora.tools import cleanup_xml_node
from mashora.tools.pdf import MashoraPdfFileReader, MashoraPdfFileWriter
...
class AccountMoveSend(models.AbstractModel):
    ...
    def _hook_invoice_document_after_pdf_report_render(self, invoice, invoice_data):
        ...
        reader = MashoraPdfFileReader(reader_buffer, strict=False)

        # Post-process.
        writer = MashoraPdfFileWriter()
