...
class TestWebsiteCrm(mashora.tests.HttpCase, TestCrmCommon):
    ...
    def test_tour(self):
        ...
        self.assertEqual(record.partner_name, 'Mashora')
    ...
    def test_catch_logged_partner_info_tour(self):
        ...
        with mashora.tests.RecordCapturer(self.env['crm.lead']) as capt:
