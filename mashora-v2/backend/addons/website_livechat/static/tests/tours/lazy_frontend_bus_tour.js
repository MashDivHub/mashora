...
registry.category("web_tour.tours").add("website_livechat.lazy_frontend_bus", {
    url: "/",
    steps: () => {
        const busService = mashora.__WOWL_DEBUG__.root.env.services.bus_service;
        ...
        const workerService = mashora.__WOWL_DEBUG__.root.env.services.worker_service;
        ...
        mashora.__WOWL_DEBUG__.root.env.services["mail.store"].isReady.then(() =>
