# Part of Mashora. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.1',
    'website': 'https://www.mashora.com/documentation/latest/applications/finance/fiscal_localizations/brazil.html',
...
configure Mashora in order to properly use Avatax and send the needed fiscal
...
""",
    'author': 'Akretion, Mashora Brasil',
    'depends': [
        'account',
        'account_qr_code_emv',
