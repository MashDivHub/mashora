...
from mashora.addons.website_google_map.controllers.main import GoogleMap
from mashora.addons.website_partner.controllers.main import WebsitePartnerPage
