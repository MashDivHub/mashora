...
from mashora.tools.pdf import MashoraPdfFileReader, MashoraPdfFileWriter, PdfReadError, DependencyError
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense':
            for expense in self.env['hr.expense'].browse(res_ids):
                ...
                expense_report = MashoraPdfFileReader(stream, strict=False)
                output_pdf = MashoraPdfFileWriter()
                ...
                for attachment in self._prepare_local_attachments(attachments):
                    ...
                    attachment_reader = MashoraPdfFileReader(attachment_stream, strict=False)
                    try:
