...
from mashora import _, api, fields, models, release
from mashora.addons.certificate.tools import CertificateAdapter
from mashora.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_agencies import get_key
from mashora.addons.l10n_es_edi_tbai.models.xml_utils import (
    NS_MAP,
...
from mashora.tools import get_lang
from mashora.tools.float_utils import float_repr, float_round
from mashora.tools.xml_utils import cleanup_xml_node
...
class L10n_Es_Edi_TbaiDocument(models.Model):
    ...
    def _get_header_values(self):
        return {
            ...
            'mashora_version': release.version,
        }
