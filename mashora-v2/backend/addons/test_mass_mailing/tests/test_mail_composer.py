...
from mashora.tests import freeze_time, tagged, users
from mashora.tools import mute_logger

from mashora.addons.test_mail.tests.test_mail_composer import TestMailComposer
from mashora.addons.test_mass_mailing.tests import common
...
class TestMailComposerMassMailing(TestMailComposer, common.TestMassMailCommon):
    ...
    @mute_logger('mashora.addons.mass_mailing.models.mailing')
