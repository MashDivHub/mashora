# Part of Mashora. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.mashora.com/documentation/latest/applications/finance/fiscal_localizations/kenya.html',
    'icon': '/account/static/description/l10n.png',
    'countries': ['ke'],
    'version': '1.0',
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This provides a base chart of accounts and taxes template for use in Mashora.
    """,
    'depends': [
        'account',
    ],
