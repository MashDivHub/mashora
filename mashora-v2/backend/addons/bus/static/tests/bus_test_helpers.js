import { after, expect, registerDebugInfo } from "@mashora/hoot";
import { Deferred } from "@mashora/hoot-mock";
import {
    MockServer,
    asyncStep,
    defineModels,
...
import { on, runAllTimers, waitUntil } from "@mashora/hoot-dom";
...
/** @type {Record<string, (env: MashoraEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<MashoraEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: MashoraEnv, id: string, payload: any) => any} handler
 */
