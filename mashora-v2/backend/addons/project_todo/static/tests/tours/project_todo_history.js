...
const descriptionField = `div.note-editable.mashora-editor-editable div.o-paragraph`;
    ...
    return [
        {
            ...
            trigger: "div.note-editable.mashora-editor-editable",
            run: "click",
        },
        {
