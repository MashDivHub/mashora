...
from mashora.exceptions import ValidationError, UserError, RedirectWarning
from mashora.fields import Command, Domain
from mashora.tools import frozendict, float_compare, groupby, Query, SQL, OrderedSet
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_mashora_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_mashora_rate(aml, other_aml, counterpart_currency)
