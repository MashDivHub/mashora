...
from mashora import api, models, modules
from mashora.exceptions import RedirectWarning
from mashora.tools import groupby
from mashora.tools.mimetypes import guess_mimetype
from mashora.tools.pdf import MashoraPdfFileReader, PdfReadError
...
def extract_pdf_embedded_files(filename, content):
    with io.BytesIO(content) as buffer:
        try:
            pdf_reader = MashoraPdfFileReader(buffer, strict=False)
