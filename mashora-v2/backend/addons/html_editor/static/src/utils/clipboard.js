 ...
 * application/vnd.mashora.mashora-editor MIME type so it can be recognized
...
export function fillHtmlTransferData(
    ...
    if (setEditorTransferData) {
        ev[transferObjectProperty].setData("application/vnd.mashora.mashora-editor", htmlContent);
    }
}
