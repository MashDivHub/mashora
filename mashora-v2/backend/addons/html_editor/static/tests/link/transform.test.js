...
import { manuallyDispatchProgrammaticEvent } from "@mashora/hoot-dom";
import { tick } from "@mashora/hoot-mock";
...
test("should show replace URL button if link is created by transformation", async () => {
    onRpc("/html_editor/link_preview_external", () => ({
        ...
        source_url: "https://mashora.com",
    }));
    const { editor } = await setupEditor(`<p>[]</p>`);
    await insertText(editor, "https://mashora.com ");
