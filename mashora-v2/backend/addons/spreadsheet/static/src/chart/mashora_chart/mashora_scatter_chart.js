...
export class MashoraScatterChart extends MashoraChart {
...
chartRegistry.add("mashora_scatter", {
    match: (type) => type === "mashora_scatter",
    createChart: (definition, sheetId, getters) =>
        new MashoraScatterChart(definition, sheetId, getters),
    getChartRuntime: createMashoraChartRuntime,
    validateChartDefinition: (validator, definition) =>
        MashoraScatterChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => MashoraScatterChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        MashoraScatterChart.getDefinitionFromContextCreation(),
    name: _t("Scatter"),
});
