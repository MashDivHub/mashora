...
export class MashoraPyramidChart extends MashoraChart {
...
chartRegistry.add("mashora_pyramid", {
    match: (type) => type === "mashora_pyramid",
    createChart: (definition, sheetId, getters) =>
        new MashoraPyramidChart(definition, sheetId, getters),
    getChartRuntime: createMashoraChartRuntime,
    validateChartDefinition: (validator, definition) =>
        MashoraPyramidChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => MashoraPyramidChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        MashoraPyramidChart.getDefinitionFromContextCreation(),
    name: _t("Pyramid"),
});
