...
import { PivotMashoraCorePlugin } from "./plugins/pivot_mashora_core_plugin";
...
coreTypes.add("UPDATE_MASHORA_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_MASHORA_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_MASHORA_PIVOT_DOMAIN", identity);

export { PivotMashoraCorePlugin, PivotCoreViewGlobalFilterPlugin, PivotUIGlobalFilterPlugin };
