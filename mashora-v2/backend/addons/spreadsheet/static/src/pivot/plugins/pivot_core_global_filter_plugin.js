...
/**
 *
 * @typedef {import("@spreadsheet").MashoraPivotDefinition} MashoraPivotDefinition
...
export class PivotCoreGlobalFilterPlugin extends MashoraCorePlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            ...
            case "DUPLICATE_PIVOT": {
                ...
                if (pivotDefinition.type !== "MASHORA") {
                    break;
                }
    ...
    export(data) {
        for (const id in this.pivots) {
            ...
            data.pivots[id].fieldMatching =
                pivot.type === "MASHORA" ? this.pivots[id].fieldMatching : {};
        }
    }
}
