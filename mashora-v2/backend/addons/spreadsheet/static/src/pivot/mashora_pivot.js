...
import { NO_RECORD_AT_THIS_POSITION, MashoraPivotModel } from "./pivot_model";
import { EvaluationError, PivotRuntimeDefinition, registries, helpers } from "@mashora/o-spreadsheet";
import { LOADING_ERROR } from "@spreadsheet/data_sources/data_source";
import { omit } from "@web/core/utils/objects";
import { MashoraPivotLoader } from "./mashora_pivot_loader";
...
/**
 * @typedef {import("@mashora/o-spreadsheet").FunctionResultObject} FunctionResultObject
 * @typedef {import("@mashora/o-spreadsheet").PivotMeasure} PivotMeasure
 * @typedef {import("@mashora/o-spreadsheet").PivotDomain} PivotDomain
 * @typedef {import("@mashora/o-spreadsheet").PivotDimension} PivotDimension
 * @typedef {import("@mashora/o-spreadsheet").PivotCoreMeasure} PivotCoreMeasure
 * @typedef {import("@spreadsheet").WebPivotModelParams} WebPivotModelParams
 * @typedef {import("@spreadsheet").MashoraPivot<MashoraPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").MashoraFields} MashoraFields
 * @typedef {import("@spreadsheet").MashoraPivotCoreDefinition} MashoraPivotCoreDefinition
 * @typedef {import("@spreadsheet").MashoraGetters} MashoraGetters
 * @typedef {import("@spreadsheet/data_sources/mashora_data_provider").MashoraDataProvider} MashoraDataProvider
 */

/**
 * @implements {IPivot}
 */
export class MashoraPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {MashoraPivotCoreDefinition} params.definition
     * @param {MashoraGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"MASHORA"} */
        this.type = "MASHORA";

        /** @type {MashoraPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {MashoraPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {MashoraPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {MashoraGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new MashoraPivotLoader(services.mashoraDataProvider, this._load.bind(this));

        /** @type {MashoraFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {MashoraDataProvider}*/
        this.mashoraDataProvider = services.mashoraDataProvider;
    ...
    /**
     * @param {MashoraPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new MashoraPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new MashoraPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new MashoraPivotModel(
            { _t },
            {
            ...
            {
                orm: this.mashoraDataProvider.orm,
                serverData: this.mashoraDataProvider.serverData,
    ...
    /**
     * @param {import("@mashora/o-spreadsheet").Maybe<FunctionResultObject>[]} args
     *
     * @returns {PivotDomain}
     */
        ...
        await Promise.all(
            related.map((dimension) =>
                getRelationalFieldDefinition(
                    ...
                    dimension.fieldName,
                    this.mashoraDataProvider.fieldService
    ...
    async _loadPropertiesDefinitions() {
        ...
        const orm = this.mashoraDataProvider.orm;
...
export class MashoraPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {MashoraPivotCoreDefinition} definition
     * @param {MashoraFields} fields
     */
...
supportedPivotPositionalFormulaRegistry.add("MASHORA", true);
