...
class BadMashoraLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadMashoraLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .replace("MashoraMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadMashoraLinkError(menuId);
                    }
                    return {
                        url,
                        label,
