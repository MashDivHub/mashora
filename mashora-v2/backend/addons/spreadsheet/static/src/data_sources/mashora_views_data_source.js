...
/**
 * @typedef {import("@spreadsheet").MashoraField} MashoraField
 * @typedef {import("@spreadsheet").MashoraFields} MashoraFields
 */

/**
 * @typedef {Object} MashoraModelMetaData
 * @property {string} resModel
 * @property {MashoraFields} [fields]
 *
 * @typedef {Object} MashoraModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class MashoraViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {MashoraModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {MashoraModelMetaData} */
    ...
    /**
     * @returns {MashoraFields} List of fields
     */
    getFields() {
     ...
     * @returns {MashoraField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
