...
import { CellErrorType, EvaluationError } from "@mashora/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./mashora_data_provider").MashoraDataProvider} MashoraDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {MashoraDataProvider} param0.mashoraDataProvider
     */
    constructor({ mashoraDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.mashoraDataProvider.orm;
    }

    get serverData() {
        return this.mashoraDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.mashoraDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.mashoraDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").MashoraFields>}
 */
