...
/**
 * @typedef {import("@mashora/o-spreadsheet").Model} Model
 ...
 * @param {Model} model
 * @param {string} type
 * @param {import("@spreadsheet/chart/mashora_chart/mashora_chart").MashoraChartDefinition} definition
 */
export function insertChartInSpreadsheet(model, type = "mashora_bar", definition = {}) {
 ...
 *
 * @returns { Promise<{ model: MashoraSpreadsheetModel, env: Object }>}
 */
