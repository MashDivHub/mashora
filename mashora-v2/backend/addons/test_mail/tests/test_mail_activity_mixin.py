...
from mashora import fields, tests
from mashora.addons.mail.models.mail_activity import MailActivity
from mashora.addons.mail.tests.common import mail_new_test_user
from mashora.addons.test_mail.tests.test_mail_activity import TestActivityCommon
