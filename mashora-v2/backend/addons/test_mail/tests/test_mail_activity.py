...
from mashora import fields, exceptions, tests
from mashora.addons.mail.tests.common import mail_new_test_user
from mashora.addons.mail.tests.common_activity import ActivityScheduleCase
from mashora.addons.test_mail.models.test_mail_models import MailTestActivity
from mashora.tests import Form, HttpCase, users
from mashora.tests.common import freeze_time
...
class TestActivitySystray(TestActivityCommon, HttpCase):
    ...
    def test_systray_activities_for_various_records(self):
        ...
        self.assertEqual(len(test_with_removed), 4, 'Even with ACL check, activities linked to removed records are kept if assigned to the user (see mashora/mashora#112126)')
