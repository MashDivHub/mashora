...
from mashora import exceptions
from mashora.addons.mail.models.mail_message import MailMessage
from mashora.addons.mail.models.mail_thread import MailThread
from mashora.addons.mail.tests.common import mail_new_test_user, MailCommon
from mashora.addons.test_mail.data import test_mail_data
from mashora.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE, MAIL_TEMPLATE_EXTRA_HTML, THAI_EMAIL_WINDOWS_874
from mashora.addons.test_mail.models.mail_test_ticket import MailTestTicket
from mashora.addons.test_mail.models.test_mail_models import MailTestGateway, MailTestGatewayGroups
from mashora.sql_db import Cursor
from mashora.tests import Form, tagged, RecordCapturer
from mashora.tools import mute_logger
from mashora.tools.mail import email_normalize, email_split_and_format, formataddr
...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_and_replace_bad_content_type(self):
        ...
        for content_type in ('binary/octet-stream', '*/*', 'bin/plain'):
            with self.subTest(content_type=content_type):
                ...
                with self.assertLogs("mashora.addons.mail.models.mail_thread", level="WARNING") as capture:
                ...
                self.assertEqual(capture.output, [
                    ("WARNING:mashora.addons.mail.models.mail_thread:Message containing an unexpected "
    ...
    def test_message_parse_eml(self):
        ...
        mail = self.format(test_mail_data.MAIL_EML_ATTACHMENT, email_from='"Sylvie Lelitre" <test.sylvie.lelitre@agrolait.com>', to=f'generic@{self.alias_domain}',
                           msg_id='<cb7eaf62-58dc-2017-148c-305d0c78892f@mashora.com>',
                           references='<f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@mashora.com>',
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.mashora.com (Mail Delivery System)',
            email_to='bounce@xxx.mashora.com',
            delivered_to='bounce@xxx.mashora.com'
        )
...
class TestMailgateway(MailGatewayCommon):
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.models')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not mashorabot:
        ...
        mashorabot.active = True
        mashorabot.email = 'mashorabot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, mashorabot.email_formatted, f'groups@{self.alias_domain}',
                subject='Mashorabot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, mashorabot)
        self.assertEqual(record4.message_ids[0].email_from, mashorabot.email_formatted)
        self.assertEqual(record4.message_follower_ids.partner_id, self.env['res.partner'],
                         'message_process: mashorabot -> no follower')
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_thread', 'mashora.models.unlink', 'mashora.tests')
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_thread', 'mashora.models')
    def test_message_route_alias_owner_author_notify(self):
        ...
        self.assertFalse(self.user_root.active, 'notification logic relies on mashorabot being archived')
        ...
        for email_to, test_user in itertools.product(email_tos, test_users):
            with self.subTest(test_user=test_user, email_to=email_to):
                ...
                self.assertEqual(new_messages.create_uid, self.user_root,
                                 'Mashorabot should be creating the message')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.models.unlink', 'mashora.addons.mail.models.mail_mail')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.addons.mail.models.mail_mail', 'mashora.models.unlink')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.addons.mail.models.mail_mail', 'mashora.models', 'mashora.sql_db')
    def test_message_process_alias_config_invalid_defaults(self):
        ...
        with self.mock_mail_gateway(), patch('mashora.addons.mail.models.mail_alias.MailAlias._alias_bounce_incoming_email',
        ...
        with self.assertRaises(Exception), patch('mashora.addons.mail.models.mail_alias.MailAlias._alias_bounce_incoming_email',
                                                 autospec=True) as _alias_bounce_incoming_email_mock:
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.models', 'mashora.tests')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.models.unlink')
    ...
    @mute_logger('mashora.addons.mail.models.mail_thread', 'mashora.models.unlink', 'mashora.addons.mail.models.mail_mail', 'mashora.tests')
    def test_message_process_external_notification_reply(self):
        ...
        self.assertFalse(new_msg.is_internal, "Responses to messages sent by mashorabot should always be public.")
        ...
        new_msg = self.test_record.message_ids[0]
        self.assertTrue(new_msg.is_internal, "Responses to messages sent by anyone but mashorabot should keep"
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by mashora should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        mashora should update thread accordingly. Special case when the
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # Mashora 10 update: compat mode has been removed and should not work anymore
    ...
    def test_message_hebrew_iso8859_8_i(self):
        ...
        # python, check that Mashora is still capable of decoding it.
...
class TestMailGatewayLoops(MailGatewayCommon):
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_thread')
    ...
    def test_routing_loop_auto_notif(self):
        """ Test Mashora servers talking to each other """
        with self.mock_mail_gateway():
            record = self.format_and_process(
                MAIL_TEMPLATE,
                self.other_partner.email_formatted,
    ...
    def test_routing_loop_follower_alias(self):
        ...
        # simulate this email coming back to the same Mashora server -> msg_id is
...
class TestMailGatewayReplies(MailGatewayCommon):
    ...
    def test_routing_reply_incoming_email(self):
        ...
        self.assertMailNotifications(
            reply,
            [{
                'content': 'Mashora Reply',
                'email_values': {
                    'message_id': reply.message_id,
                    'references': f'{email.message_id} {log.message_id} {reply.message_id}',  # should contain reference to MashoraExternal message, logs to fill up history
                },
                'mail_mail_values': {
    ...
    def test_routing_reply_internal_messages(self):
        """ Test routing notably between two Mashoras when internal messages
        ...
        Action                  Mashora1                   Mashora2
        RFQ-like                                        creation log
                                                        initial_msg
        Mashora2 replies           creation log
                                reply                   reply
        -some internal work-                            user_notification
        Mashora1 replies           reply_2                 reply_2 (incoming email)
        -some internal work-                            log
        Mashora2 replies           reply_3                 reply_3 (outgoing email)

        Purpose: have references from Mashora2 containing message IDs to try to
        ...
        gateway_record.message_post(
            author_id=self.env.ref('base.partner_root').id,
            body='MashoraExternal Inquiry',
            email_from=self.partner_1.email_normalized,
            message_type='comment',
            subtype_id=self.env.ref('mail.mt_comment').id,
        )
        self.assertEqual(gateway_record.message_partner_ids, self.partner_admin)
        log, mashoraext_msg = gateway_record.message_ids[1], gateway_record.message_ids[0]
        self.assertEqual(mashoraext_msg.parent_id, log, 'Log serves as thread ancestor')
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    'message_id': reply.message_id,
                    'references': f'{log.message_id} {mashoraext_msg.message_id} {reply.message_id}',  # should contain reference to MashoraExternal message
                },
                'mail_mail_values': {
                    'notified_partner_ids': self.partner_1 + self.partner_admin,
                    'parent_id': mashoraext_msg,  # attached to last comment / email when possible
                },
                'notif': [
                    {'partner': self.partner_1, 'type': 'email',},
        ...
        # coming from Mashora1: their reply as an incoming email
        with self.mock_mail_gateway():
            self.format_and_process(
                MAIL_TEMPLATE, self.email_from, reply.reply_to,
                subject='Gateway Creation',
                date=datetime.now(),
                extra=f'References: {reply.message_id} <msg1@mashora1>',
                debug_log=True,
            )
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    ...
                    'references': f'{log.message_id} {mashoraext_msg.message_id} {reply.message_id} {reply_2.message_id}',  # should contain reference to MashoraExternal message
                },
                'mail_mail_values': {
        ...
        self.assertMailNotifications(
            reply_3,
            [{
                'content': 'Mashora Reply 2',
                'email_values': {
                    'message_id': reply_3.message_id,
                    'references': f'{mashoraext_msg.message_id} {reply.message_id} {reply_2.message_id} {reply_3.message_id}',  # should contain reference to MashoraExternal message
                },
                'mail_mail_values': {
                    'notified_partner_ids': self.partner_1 + self.partner_admin,
