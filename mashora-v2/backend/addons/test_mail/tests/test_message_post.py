...
from mashora.addons.base.tests.test_ir_cron import CronMixinCase
from mashora.addons.mail.tests.common import mail_new_test_user, MailCommon
from mashora.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from mashora.addons.test_mail.models.test_mail_models import MailTestSimple
from mashora.addons.test_mail.tests.common import TestRecipients
from mashora.service.model import call_kw
from mashora.exceptions import AccessError
from mashora.tests import tagged
from mashora.tools import mute_logger, formataddr
from mashora.tests.common import users
...
class TestMailNotifyAPI(TestMessagePostCommon):
    ...
    @mute_logger('mashora.models.unlink')
    @users('employee')
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.models.unlink', 'mashora.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.models.unlink')
    @users('employee')
    def test_message_post(self):
        ...
        exp_headers = {
            ...
            'X-Mashora-Objects': f'{test_record._name}-{test_record.id}',
        }
        with self.assertSinglePostNotifications(
                [
                    {'partner': self.partner_employee_2, 'type': 'inbox'},
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. mashorabot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Mashora-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.tests')
    ...
    @users('employee')
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_message_schedule', 'mashora.models.unlink')
    ...
    @mute_logger('mashora.addons.mail.models.mail_mail', 'mashora.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('mashora.addons.base.models.ir_model', 'mashora.addons.mail.models.mail_mail')
