...
from mashora import api, http, SUPERUSER_ID, _
...
from mashora.addons.auth_signup.controllers.main import AuthSignupHome as Home
from mashora.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/mashora/action-%s' % action
            elif menu:
                url = '/mashora?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via Mashora Account provider"""
