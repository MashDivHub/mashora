...
patch(PaymentForm.prototype, {
    ...
    /**
     * Load the JS from the PayPal SDK URL and set an identifier dedicated to Mashora, for PayPal to be
     * able to recognize which transactions are originating from Mashora.
     *
     * @private
    ...
    async _paypalLoadSDK(paypalSDKURL) {
        ...
        [...paypalSDKs].forEach(sdk => {
            sdk.setAttribute('data-partner-attribution-id', 'MashoraInc_SP_EC');
        });
    },
