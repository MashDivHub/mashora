...
from mashora import _, fields, models
...
from mashora.addons.payment_paypal import const
...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(
        ...
        headers = {
            ...
            # PayPal requires a reference specific to Mashora to be able to track Mashora customers.
            'PayPal-Partner-Attribution-Id': 'MashoraInc_SP_EC',
        }
        if idempotency_key:
