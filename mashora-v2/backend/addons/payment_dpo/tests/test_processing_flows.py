...
from mashora.addons.payment_dpo.controllers.main import DPOController
from mashora.addons.payment_dpo.tests.common import DPOCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(DPOCommon, PaymentHttpCommon):

    @mute_logger('mashora.addons.payment_dpo.controllers.main')
    def test_redirect_notification_triggers_processing(self):
        ...
        with patch(
            'mashora.addons.payment_dpo.controllers.main.DPOController._verify_and_process'
