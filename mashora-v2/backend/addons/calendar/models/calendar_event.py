...
from mashora.addons.base.models.res_partner import _tz_get
from mashora.addons.calendar.models.calendar_attendee import CalendarAttendee
from mashora.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from mashora.addons.calendar.models.utils import interval_from_events
from mashora.tools.intervals import intervals_overlap
from mashora.tools.translate import _
from mashora.tools.misc import get_lang
from mashora.tools import html2plaintext, html_sanitize, is_html_empty, single_email_re
...
class CalendarEvent(models.Model):
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Mashora'
    ...
    def _get_contact_details_description(self, organizer, partners):
        ...
        """
        mashorabot = self.env.ref('base.user_root')
        contact_description = []
        # Organizer
        if organizer and organizer != mashorabot:
        ...
        first_partner = partners.filtered(lambda partner: partner not in (mashorabot.partner_id + organizer.partner_id))[:1]
        if first_partner:
