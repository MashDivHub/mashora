...
from mashora.tests.common import TransactionCase, new_test_user
...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('mashora.tests', 'mashora.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_mashora(self):
        # set notifications to "handle in Mashora" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Mashora" notification setting can
