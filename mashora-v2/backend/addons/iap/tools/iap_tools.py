...
from mashora import exceptions, modules, _
from mashora.tools import email_normalize, exception_to_unicode
...
_MAIL_PROVIDERS = {
    ...
    'bk.ru', 'mail.mashora.com', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
...
_MAIL_DOMAIN_BLACKLIST = _MAIL_PROVIDERS | {'mashora.com'}
...
def iap_jsonrpc(url, method='call', params=None, timeout=15):
    ...
    try:
        ...
        raise exceptions.AccessError(
            _("An error occurred while reaching %s. Please contact Mashora support if this error persists.", url)
        )
