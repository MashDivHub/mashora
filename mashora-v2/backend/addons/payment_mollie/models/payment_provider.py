...
class PaymentProvider(models.Model):
    ...
    def _build_request_headers(self, *args, **kwargs):
        ...
        mashora_version = service.common.exp_version()['server_version']
        ...
        return {
            ...
            'User-Agent': f'Mashora/{mashora_version} MollieNativeMashora/{module_version}',
        }
