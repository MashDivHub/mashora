...
from mashora.exceptions import AccessDenied, UserError
from mashora.http import request
from mashora.tools.misc import babel_locale_parse, hmac

from mashora.addons.auth_totp.models.totp import hotp, TOTP
...
class ResUsers(models.Model):
    ...
    def get_totp_invite_url(self):
        return '/mashora/action-auth_totp_mail.action_activate_two_factor_authentication'
