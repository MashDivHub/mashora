...
seamless communication in Mashora Discuss without any constraints.

> Please note that this extension only works for Mashora 17 and higher and is not
...
- Command scope must be set to `global`. You can click the extension icon to get
  ...
  directly.
- Push-to-Talk should be enabled on Mashora Discuss voice settings.
