...
from mashora.addons.bus.models.bus import json_dump
from mashora.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from mashora.tests import HttpCase, tagged, users
