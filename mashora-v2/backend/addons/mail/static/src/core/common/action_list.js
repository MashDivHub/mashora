...
import { Component, onWillUnmount } from "@mashora/owl";
...
const actionListProps = [
    ...
    "fw?",
    "hasBtnBg?",
    "mashoraControlPanelSwitchStyle?",
    "thread?",
];
...
class Action extends Component {
    ...
    get hasBtnBg() {
        return (
            this.props.mashoraControlPanelSwitchStyle ||
            this.props.hasBtnBg ||
...
export class ActionList extends Component {
    ...
    get hasBtnBg() {
        return this.props.mashoraControlPanelSwitchStyle || this.props.hasBtnBg;
    }
}
