...
test("add_link utility function", () => {
    const testInputs = {
        ...
        "https://www.transifex.com/mashora/mashora-11/translate/#fr/lunch?q=text%3A'La+Tartiflette'": true,
        "https://www.transifex.com/mashora/mashora-11/translate/#fr/$/119303430?q=text%3ATartiflette": true,
        "https://tenor.com/view/chỗgiặt-dog-smile-gif-13860250": true,
        "http://www.boîtenoire.be": true,
        "https://github.com/mashora/enterprise/compare/16.0...mashora-dev:enterprise:16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/mashora/enterprise/compare/16.0...16.0-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/mashora/enterprise/compare/16.0...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/mashora/enterprise/compare/chỗgiặt...chỗgiặt-voip-fix_demo_data-tsm?expand=1": true,
        "https://github.com/mashora/enterprise/compare/@...}-voip-fix_demo_data-tsm?expand=1": true,
        "https://x.com": true,
    };
...
test("addLink: utility function and special entities", () => {
    const testInputs = [
        ...
        [
            markup`https://mashora.com/%5B%5D`,
            `<a target="_blank" rel="noreferrer noopener" href="https://mashora.com/%5B%5D">https://mashora.com/[]</a>`,
        ],
    ];
...
test("url", async () => {
    ...
    const messageBody = "https://mashora.com?test=~^|`{}[]#";
...
test("url with comma at the end", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "Go to https://mashora.com, it's great!";
    await insertText(".o-mail-Composer-input", messageBody);
    await press("Enter");
    await contains(".o-mail-Message a:contains(https://mashora.com)");
...
test("url with number in subdomain", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    const messageBody = "https://www.45017478-master-all.runbot134.mashora.com/mashora";
    await insertText(".o-mail-Composer-input", messageBody);
    await press("Enter");
    await contains(
        ".o-mail-Message a:contains(https://www.45017478-master-all.runbot134.mashora.com/mashora)"
    );
});
