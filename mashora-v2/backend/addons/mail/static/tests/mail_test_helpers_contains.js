/** @mashora-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@mashora/hoot";
import { queryAll, queryFirst } from "@mashora/hoot-dom";
 ...
 *
 * @param {import("@mashora/hoot-dom").Target} selector
 ...
 *  element.
 * @property {HTMLElement|MashoraEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when MashoraEnv, special key `target`. See @start
