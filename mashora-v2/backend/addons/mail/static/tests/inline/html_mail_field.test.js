...
import { after, before, beforeEach, expect, test } from "@mashora/hoot";
import { press, queryOne } from "@mashora/hoot-dom";
import { animationFrame, enableTransitions } from "@mashora/hoot-mock";
import {
    clickSave,
    contains,
    defineModels,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".mashora-editor-editable").toHaveInnerHTML("<h1> first </h1>");
