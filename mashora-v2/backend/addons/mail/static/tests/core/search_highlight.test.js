...
test("Search highlight", async () => {
    const testCases = [
        {
            input: markup`test mashora`,
            output: `test <span class="${HIGHLIGHT_CLASS}">mashora</span>`,
            searchTerm: "mashora",
        },
        {
            input: markup`<a href="https://www.mashora.com">https://www.mashora.com</a>`,
            output: `<a href="https://www.mashora.com">https://www.<span class="${HIGHLIGHT_CLASS}">mashora</span>.com</a>`,
            searchTerm: "mashora",
        },
        {
            input: '<a href="https://www.mashora.com">https://www.mashora.com</a>',
            output: `&lt;a href="https://www.<span class="${HIGHLIGHT_CLASS}">mashora</span>.com"&gt;https://www.<span class="${HIGHLIGHT_CLASS}">mashora</span>.com&lt;/a&gt;`,
            searchTerm: "mashora",
        },
        {
            input: markup`<a href="https://www.mashora.com">Mashora</a>`,
            output: `<a href="https://www.mashora.com"><span class="${HIGHLIGHT_CLASS}">Mashora</span></a>`,
            searchTerm: "mashora",
        },
        {
            input: markup`<a href="https://www.mashora.com">Mashora</a> Mashora is a free software`,
            output: `<a href="https://www.mashora.com"><span class="${HIGHLIGHT_CLASS}">Mashora</span></a> <span class="${HIGHLIGHT_CLASS}">Mashora</span> is a free software`,
            searchTerm: "mashora",
        },
        {
            input: markup`mashora is a free software`,
            output: `<span class="${HIGHLIGHT_CLASS}">mashora</span> is a free software`,
            searchTerm: "mashora",
        },
        {
            input: markup`software MASHORA is a free`,
            output: `software <span class="${HIGHLIGHT_CLASS}">MASHORA</span> is a free`,
            searchTerm: "mashora",
        },
        {
            input: markup`<ul>
                <li>Mashora</li>
                <li><a href="https://mashora.com">Mashora ERP</a> Best ERP</li>
            </ul>`,
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">Mashora</span></li>
                <li><a href="https://mashora.com"><span class="${HIGHLIGHT_CLASS}">Mashora</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "mashora",
        },
        {
            input: markup`test <strong>Mashora</strong> test`,
            output: `<span class="${HIGHLIGHT_CLASS}">test</span> <strong><span class="${HIGHLIGHT_CLASS}">Mashora</span></strong> <span class="${HIGHLIGHT_CLASS}">test</span>`,
            searchTerm: "mashora test",
        },
        {
