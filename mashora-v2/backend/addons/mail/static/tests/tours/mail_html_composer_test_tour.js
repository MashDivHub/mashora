    ...
    steps: () => [
        {
            ...
            async run() {
                const composerService = mashora.__WOWL_DEBUG__.root.env.services["mail.composer"];
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.mashora-editor-editable",
            run: "editor Hello",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.mashora-editor-editable strong:contains(Hello)",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_mail_composer_message .mashora-editor-editable",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o-mail-Composer-html.mashora-editor-editable em:contains(Hello)",
        },
    ],
});
