...
from mashora import models, api, _
from mashora.fields import Domain
from mashora.tools import date_utils
...
class AccountAccount(models.Model):
    ...
    def spreadsheet_fetch_debit_credit(self, args_list):
        """Fetch data for MASHORA.CREDIT, MASHORA.DEBIT and MASHORA.BALANCE formulas
    ...
    def spreadsheet_fetch_residual_amount(self, args_list):
        """Fetch data for MASHORA.RESUDUAL formulas
        The input list looks like this::
    ...
    def spreadsheet_fetch_partner_balance(self, args_list):
        """Fetch data for MASHORA.PARTNER.BALANCE formulas
        The input list looks like this::
    ...
    def spreadsheet_fetch_balance_tag(self, args_list):
        """Fetch data for MASHORA.BALANCE.TAG formulas
        The input list looks like this::
