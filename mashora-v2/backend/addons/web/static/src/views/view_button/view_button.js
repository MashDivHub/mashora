...
const mashoraToBootstrapClasses = {
...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(mashora.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in mashoraToBootstrapClasses) {
                    cls = mashoraToBootstrapClasses[cls];
                }
                classNames.push(cls);
