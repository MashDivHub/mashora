import { Component, markup } from "@mashora/owl";
...
export function mashoraAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Mashora.com Account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.mashora.com/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("mashora_account", mashoraAccountItem)
