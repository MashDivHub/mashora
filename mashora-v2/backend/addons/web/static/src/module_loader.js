...
(function (mashora) {
    ...
    class ModuleLoader {
        /** @type {MashoraModuleLoader["bus"]} */
        bus = new EventTarget();
        /** @type {MashoraModuleLoader["checkErrorProm"]} */
        checkErrorProm = null;
        /** @type {MashoraModuleLoader["factories"]} */
        factories = new Map();
        /** @type {MashoraModuleLoader["failed"]} */
        failed = new Set();
        /** @type {MashoraModuleLoader["jobs"]} */
        jobs = new Set();
        /** @type {MashoraModuleLoader["modules"]} */
        modules = new Map();
        ...
        /** @type {MashoraModuleLoader["addJob"]} */
        addJob(name) {
            this.jobs.add(name);
            this.startModules();
        }

        /** @type {MashoraModuleLoader["define"]} */
        define(name, deps, factory, lazy = false) {
            ...
            this.factories.set(name, {
                deps,
                fn: factory,
                ignoreMissingDeps: globalThis.__mashoraIgnoreMissingDependencies,
            });
            if (!lazy) {
                this.addJob(name);
        ...
        /** @type {MashoraModuleLoader["findErrors"]} */
        ...
        /** @type {MashoraModuleLoader["findJob"]} */
        findJob() {
        ...
        /** @type {MashoraModuleLoader["reportErrors"]} */
        ...
        /** @type {MashoraModuleLoader["startModules"]} */
        startModules() {
            let job;
        ...
        /** @type {MashoraModuleLoader["startModule"]} */
        startModule(name) {
            /** @type {(dependency: string) => MashoraModule} */
            const require = (dependency) => this.modules.get(dependency);
            this.jobs.delete(name);
            const factory = this.factories.get(name);
            /** @type {MashoraModule | null} */
            let module = null;
            try {
    ...
    mashora.define = loader.define.bind(loader);
    mashora.loader = loader;

    if (mashora.debug && !loader.debug) {
