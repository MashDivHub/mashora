...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    // Mashora: don't support scripting (#115302)
    enableScripting: false,
    enableUpdatedAddImage: false,
    // Mashora: open links in new tabs to keep mashora document (#84594)
...
class PDFPrintService {
  ...
  layout() {
    ...
    // MASHORA PATCH PRINT PREVIEW MOBILE
...
window.print = function () {
  ...
  try {
    ...
    // MASHORA: FIX MOBILE PRINT PREVIEW
