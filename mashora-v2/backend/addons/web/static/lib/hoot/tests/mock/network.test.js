...
import { after, describe, expect, mockFetch, test } from "@mashora/hoot";
...
describe(parseUrl(import.meta.url), () => {
    ...
    test("fetch with internal URLs should return default value", async () => {
        ...
        const internal = await fetch("/mashora").then((res) => res.text());
        ...
        expect.verifySteps(["http://some.url", "/mashora", "data:text/html,<body></body>"]);
    });
