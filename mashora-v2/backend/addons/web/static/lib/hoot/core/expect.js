...
import { markRaw } from "@mashora/owl";
import {
    formatXml,
    getActiveElement,
    getNodeAttribute,
 ...
 *
 * @typedef {import("@mashora/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@mashora/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@mashora/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@mashora/hoot-dom").QueryTextOptions} QueryTextOptions
 * @typedef {import("@mashora/hoot-dom").Target} Target
 */
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/mashora/i);
     */
