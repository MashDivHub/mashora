/** @mashora-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@mashora/hoot";
import { hover, queryFirst } from "@mashora/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@mashora/hoot-mock";
import { Component, onPatched, xml } from "@mashora/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
