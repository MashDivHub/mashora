...
import { mockDate, mockTimeZone } from "@mashora/hoot-mock";
import { Component, onRendered, onWillStart, xml } from "@mashora/owl";
import {
    MockServer,
    contains,
    defineActions,
...
/**
 * @param {import("@mashora/hoot-dom").Target} from
 * @param {import("@mashora/hoot-dom").Target} to
 * @param {{
