import { after, destroy, getFixture, queryFirst, queryOne } from "@mashora/hoot";
import { App, Component, xml } from "@mashora/owl";
 ...
 * @typedef {import("@mashora/owl").Component} Component
 * @typedef {import("@web/env").MashoraEnv} MashoraEnv
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@mashora/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
 ...
 * @template [P={}]
 * @template [E=MashoraEnv]
 * @param {C | string} ComponentClass
 * @param {AppConfig & {
 *  componentEnv?: Partial<MashoraEnv>;
 *  containerEnv?: Partial<MashoraEnv>;
