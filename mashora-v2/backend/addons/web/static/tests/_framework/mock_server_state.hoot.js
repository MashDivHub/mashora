...
import { after, before, beforeEach, createJobScopedGetter } from "@mashora/hoot";
import { validateType } from "@mashora/owl";

const { view_info } = mashora.__session_info__ || {};
...
const SERVER_STATE_VALUES_SCHEMA = {
    ...
    lang: String,
    multiLang: Boolean,
    mashorabotId: [Number, { value: false }],
