...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        mashora.define = this.define.bind(this);
        mashora.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@mashora` (`@mashora/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `mashora` in the dependencies
     */
    spreadsheet: ["mashora"],
    /**
...
const CSRF_TOKEN = mashora.csrf_token;
...
const R_DEFAULT_MODULE = /^@mashora\/(owl|hoot)/;
