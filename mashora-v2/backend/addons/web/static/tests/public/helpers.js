import { getFixture, after } from "@mashora/hoot";
...
export async function startInteractions(
    ...
    if (mashora.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = mashora.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
