/** @mashora-module alias=@web/../tests/setup default=false */
...
import { App, EventBus, whenReady } from "@mashora/owl";
...
function makeMockLocation() {
    return Object.assign(document.createElement("a"), {
        href: window.location.origin + "/mashora",
        assign(url) {
            this.href = url;
        },
        reload() {},
