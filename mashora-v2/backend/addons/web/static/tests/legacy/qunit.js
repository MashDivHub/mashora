/** @mashora-module alias=@web/../tests/qunit default=false */
...
import { Component, whenReady } from "@mashora/owl";
...
export function setupQUnit() {
    ...
    QUnit.done(async (result) => {
        await mashora.loader.checkErrorProm;
    ...
    QUnit.begin(function () {
        if (mashora.debug && mashora.debug.includes("assets")) {
    ...
    QUnit.on("MashoraAfterTestHook", (info) => {
