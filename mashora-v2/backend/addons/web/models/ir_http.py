...
from mashora.http import request, DEFAULT_MAX_CONTENT_LENGTH
from mashora.tools import config
from mashora.tools.misc import hmac, str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = mashora.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.mashora.com/buy",
            "name": user.name,
            "username": user.login,
