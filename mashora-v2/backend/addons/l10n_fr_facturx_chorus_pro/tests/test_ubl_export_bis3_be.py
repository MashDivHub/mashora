from mashora.addons.account_edi_ubl_cii.tests.test_ubl_export_bis3_be import TestUblExportBis3BE
from mashora.addons.l10n_fr_facturx_chorus_pro.tests.common import TestUblCiiCommonChorusPro
