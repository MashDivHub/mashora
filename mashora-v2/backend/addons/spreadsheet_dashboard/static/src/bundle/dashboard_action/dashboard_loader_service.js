import { reactive } from "@mashora/owl";
...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency, translationNamespace) {
        const mashoraDataProvider = new MashoraDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, mashoraDataProvider, translationNamespace },
                mode: "dashboard",
        ...
        mashoraDataProvider.addEventListener("data-source-updated", () =>
