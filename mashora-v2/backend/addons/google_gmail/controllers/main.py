...
from mashora.tools import consteq, email_normalize
from mashora.addons.google_gmail.models.google_gmail_mixin import GMAIL_TOKEN_REQUEST_TIMEOUT
...
class GoogleGmailController(http.Controller):
    ...
    def _get_redirect_url(self, record):
        ...
        if (
            ...
            return f'/mashora/{record._name}/{record.id}'
        return f'/mashora/my-preferences/{request.env.user.id}'
