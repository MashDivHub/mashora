...
from mashora.addons.sms.models.sms_sms import SmsSms
from mashora.addons.sms.tools.sms_api import SmsApi
...
class SMSCase(MockSMS):
    ...
    def assertSMSNotification(self, recipients_info, content, messages=None, check_sms=True, sent_unlink=False,
        ...
        if messages is not None:
            ...
            with patch('mashora.tools.mail.SANITIZE_TAGS', sanitize_tags):
