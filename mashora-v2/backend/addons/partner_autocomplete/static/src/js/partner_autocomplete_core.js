...
import { onWillStart } from "@mashora/owl";
...
export function usePartnerAutocomplete() {
    const keepLastMashora = new KeepLast();
    ...
    /**
     * Use Mashora Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Promise}
    ...
    async function getSuggestions(value, isVAT, queryCountryId) {
        ...
        const suggestions = await keepLastMashora.add(prom);
