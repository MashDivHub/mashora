...
from mashora.addons.pos_restaurant.tests.test_frontend import TestFrontendCommon
from mashora.addons.pos_self_order.tests.self_order_common_test import SelfOrderCommonTest
from unittest.mock import patch
from mashora.addons.http_routing.models import ir_http
from mashora.addons.pos_online_payment.controllers.payment_portal import PaymentPortal
