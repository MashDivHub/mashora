...
from mashora.exceptions import AccessDenied, AccessError
from mashora.http import _request_stack
from mashora.service import common as auth
from mashora.service import model
from mashora.tests import common
from mashora.tools import DotDict, mute_logger

from mashora.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestXMLRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        ml_xml = mute_logger('mashora.addons.rpc.controllers.xmlrpc')
        ml_xml.__enter__()  # noqa: PLC2801
        self.addCleanup(ml_xml.__exit__)

        ml_json = mute_logger('mashora.addons.rpc.controllers.jsonrpc')
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   mashora.api.model(lambda *_: collections.defaultdict(int)))
