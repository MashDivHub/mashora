...
import mashora
from mashora import http, models
from mashora.api import Self
from mashora.exceptions import AccessError
from mashora.http import content_disposition, request
from mashora.modules.module_graph import ModuleGraph
from mashora.service.model import get_public_method
from mashora.tools import hmac, json_default, lazy_classproperty, py_to_js_locale
...
class DocController(http.Controller):
    ...
    def doc_index(self):
        ...
        if parse_cache_control_header(request.httprequest.headers.get('Cache-Control')).no_cache:
            ...
            return request.make_json_response(
                ...
                headers={
                    ...
                    'Content-Disposition': content_disposition('mashora-doc-index.json'),
        ...
        filename = f'mashora-doc-index-{db_registry_sequence}-{unique}.json'
...
DOC_API_MAGIC_COLUMNS = list(mashora.models.MAGIC_COLUMNS)
...
# works much better than mashora.tools.lazy.
class _DocUtils:
