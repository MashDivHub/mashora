import { Component, useState, onMounted, useSubEnv } from "@mashora/owl";
...
export class DocClient extends Component {
    ...
    setup() {
        this.setTheme(localStorage.getItem("theme") || "mashora-dark");
    ...
    toggleTheme() {
        this.setTheme(this.theme === "mashora-dark" ? "mashora-light" : "mashora-dark");
    }
