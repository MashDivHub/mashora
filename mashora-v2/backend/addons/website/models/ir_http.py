...
import mashora
from mashora import api, models, tools
from mashora import SUPERUSER_ID
...
from mashora.addons.http_routing.models import ir_http
from mashora.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from mashora.addons.website.models import ir_http
...
class IrHttp(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(mashora.tools.config['server_wide_modules'])
