...
from mashora.addons.website.controllers.main import Website
...
from mashora.tools import config, mute_logger
...
class WithContext(HttpCase):
    ...
    @mute_logger('mashora.addons.rpc.controllers.xmlrpc')
