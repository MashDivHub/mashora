...
from mashora.addons.payment_authorize.tests.common import AuthorizeCommon
...
class TestRefundFlows(AuthorizeCommon):
    ...
    def test_refunding_voided_tx_cancels_it(self):
        ...
        with patch(
            'mashora.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
    ...
    def test_refunding_refunded_tx_creates_refund_tx(self):
        ...
        a refund transaction on Mashora. """
        source_tx = self._create_transaction('direct', state='done')
        with patch(
            'mashora.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
            '.get_transaction_details',
    ...
    @mute_logger('mashora.addons.payment_authorize.models.payment_transaction')
    def test_refunding_authorized_tx_voids_it(self):
        ...
        with patch(
            ...
            'mashora.addons.payment_authorize.models.authorize_request.AuthorizeAPI.void'
        ) as void_mock, patch(
    ...
    def test_refunding_captured_tx_refunds_it_and_creates_refund_tx(self):
        ...
        create a refund transaction on Mashora. """
        source_tx = self._create_transaction('direct', state='done')
        with patch(
            'mashora.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
            '.get_transaction_details',
            ...
            'mashora.addons.payment_authorize.models.authorize_request.AuthorizeAPI.refund'
    ...
    def test_voided_refund_tx_is_done(self):
        ...
        with patch(
            ...
            'mashora.addons.payment.models.payment_transaction.PaymentTransaction._validate_amount'
        ):
