...
- `16.1`
  - The "Authorize Currency" field is replaced by the generic "Currencies" field of `payment`.
    mashora/mashora#101018
- `16.0`
  - Archiving a token no longer deactivates the related payment method on Authorize. mashora/mashora#93774
- `15.4`
  - The support for full refunds is added. mashora/mashora#92279
- `15.0`
  - Support for ACH payments is added. mashora/mashora#75289
- `14.3`
  - The payment with redirection flow that existed alongside the direct payment flow is dropped.
    mashora/mashora#141661
