...
import { Component, onWillStart, useEffect, useRef } from "@mashora/owl";
...
export class ReplenishmentGraphWidget extends JsonPopOver {
    ...
    getScatterGraphConfig() {
        ...
        const maxLineColor = getColor(1, cookie.get("color_scheme"), "mashora");
        const minLineColor = getColor(2, cookie.get("color_scheme"), "mashora");
        const curveLineColor = getColor(3, cookie.get("color_scheme"), "mashora");
        return {
            type: "scatter",
            data: {
                labels,
