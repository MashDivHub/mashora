...
from mashora import _, api, Command, fields, models, SUPERUSER_ID
from mashora.exceptions import UserError, ValidationError
from mashora.fields import Domain
from mashora.tools.float_utils import float_compare, float_is_zero, float_round
from mashora.tools.misc import clean_context, OrderedSet, groupby
...
Please change the quantity done or the rounding precision in your settings.""",
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=mashorabot_id, subject=msg_subject)
