...
from mashora.tools import float_is_zero
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~mashora.addons.product.models.product.ProductProduct`
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type procurements: list of `~mashora.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
