...
- `19.0`
  - OAuth support is added in addition to the credentials-based authentication. mashora/mashora#194998
  - Support for tokenization is added. mashora/mashora#194998
- `16.0`
  - The first version of the module is merged. mashora/mashora#83957
