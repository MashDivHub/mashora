...
from mashora import _, fields
from mashora.exceptions import ValidationError
from mashora.http import Controller, request, route
...
class MercadoPagoOnboardingController(Controller):
    ...
    def mercado_pago_return_from_authorization(self, **data):
        ...
        # Retrieve the Mercado Pago data and Mashora metadata from the redirect data.
        ...
        redirect_url = f'/mashora/action-{action.id}/{int(provider_sudo.id)}'
